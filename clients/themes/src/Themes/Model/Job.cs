...
namespace Themes.Model
{
        ...
        public partial class Job :  IEquatable<Job>, IValidatableObject
    {
        ...
        public Job(List<JobErrors> errors = default(List<JobErrors>), string id = default(string), decimal? percentComplete = default(decimal?), Dictionary<string, string> result = default(Dictionary<string, string>), StatusEnum? status = default(StatusEnum?), DateTime? time = default(DateTime?), List<JobWarnings> warnings = default(List<JobWarnings>))
        {
            this.Errors = errors;
            this.Id = id;
