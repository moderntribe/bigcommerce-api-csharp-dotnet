...
namespace Themes.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ThemeResponse :  IEquatable<ThemeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ThemeResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public ThemeResponse(ThemesCollectionResponseData data = default(ThemesCollectionResponseData), CollectionMeta meta = default(CollectionMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public ThemesCollectionResponseData Data { get; set; }
