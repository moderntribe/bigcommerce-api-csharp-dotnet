...
${nuget_cmd} install src/Themes/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Themes.dll"
...
then
  ...
  echo "[INFO] bin/Themes.dll was created successfully"
fi
