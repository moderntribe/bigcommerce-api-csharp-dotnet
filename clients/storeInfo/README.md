# StoreInfo - the C# library for the Store Information
...
```
nuget pack -Build -OutputDirectory out StoreInfo.csproj
```
...
------------ | ------------- | ------------- | -------------
*StoreInformationApi* | [**StoreGet**](docs/StoreInformationApi.md#storeget) | **GET** /store | Get Store Information
*TimeZoneApi* | [**TimeGet**](docs/TimeZoneApi.md#timeget) | **GET** /time | Get System Timestamp

<a name="documentation-for-models"></a>
## Documentation for Models

 - [Model.DateFormat](docs/DateFormat.md)
 - [Model.StoreInformation](docs/StoreInformation.md)
 - [Model.StoreInformationFeatures](docs/StoreInformationFeatures.md)
 - [Model.StoreInformationLogo](docs/StoreInformationLogo.md)
 - [Model.TimeStampFull](docs/TimeStampFull.md)
 - [Model.TimeStampFull1](docs/TimeStampFull1.md)
