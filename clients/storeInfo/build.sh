...
${nuget_cmd} install src/StoreInfo/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/StoreInfo.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/StoreInfo.dll \
-recurse:'src/StoreInfo/*.cs' \
-doc:bin/StoreInfo.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/StoreInfo.dll was created successfully"
fi
