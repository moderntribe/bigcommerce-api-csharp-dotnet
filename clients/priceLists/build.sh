...
${nuget_cmd} install src/PriceLists/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/PriceLists.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/PriceLists.dll \
-recurse:'src/PriceLists/*.cs' \
-doc:bin/PriceLists.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/PriceLists.dll was created successfully"
fi
