...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListResponse1 :  IEquatable<PriceListResponse1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">Empty meta object; may be used later..</param>
        public PriceListResponse1(PriceList data = default(PriceList), Object meta = default(Object))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceListResponse1 {\n");
        ...
        {
            return this.Equals(input as PriceListResponse1);
        }

        /// <summary>
        /// Returns true if PriceListResponse1 instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListResponse1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListResponse1 input)
        {
            if (input == null)
                return false;
