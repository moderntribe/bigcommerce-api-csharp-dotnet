...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssignmentForGetResponse :  IEquatable<AssignmentForGetResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignmentForGetResponse" /> class.
        /// </summary>
        ...
        public AssignmentForGetResponse(int? id = default(int?), int? customerGroupId = default(int?), int? priceListId = default(int?), int? channelId = default(int?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssignmentForGetResponse {\n");
        ...
        {
            return this.Equals(input as AssignmentForGetResponse);
        }

        /// <summary>
        /// Returns true if AssignmentForGetResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AssignmentForGetResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssignmentForGetResponse input)
        {
            if (input == null)
                return false;
