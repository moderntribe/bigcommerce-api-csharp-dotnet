...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData :  IEquatable<AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData" /> class.
        /// </summary>
        public AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData);
        }

        /// <summary>
        /// Returns true if AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData input)
        {
            if (input == null)
                return false;
