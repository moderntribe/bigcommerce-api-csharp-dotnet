...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListCollectionResponse :  IEquatable<PriceListCollectionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListCollectionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public PriceListCollectionResponse(List<AllOfPriceListCollectionResponseDataItems> data = default(List<AllOfPriceListCollectionResponseDataItems>), CollectionMeta meta = default(CollectionMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<AllOfPriceListCollectionResponseDataItems> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceListCollectionResponse {\n");
        ...
        {
            return this.Equals(input as PriceListCollectionResponse);
        }

        /// <summary>
        /// Returns true if PriceListCollectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListCollectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListCollectionResponse input)
        {
            if (input == null)
                return false;
