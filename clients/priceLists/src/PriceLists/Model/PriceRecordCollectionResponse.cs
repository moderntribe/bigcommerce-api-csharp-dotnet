...
{
    /// <summary>
    /// PriceRecord Collection Response returns for: * Get All PriceList Records * Get PriceList Records by Variant Id
    /// </summary>
    [DataContract]
        public partial class PriceRecordCollectionResponse :  IEquatable<PriceRecordCollectionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordCollectionResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">meta.</param>
        public PriceRecordCollectionResponse(List<AllOfPriceRecordCollectionResponseDataItems> data = default(List<AllOfPriceRecordCollectionResponseDataItems>), CollectionMeta meta = default(CollectionMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<AllOfPriceRecordCollectionResponseDataItems> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordCollectionResponse {\n");
        ...
        {
            return this.Equals(input as PriceRecordCollectionResponse);
        }

        /// <summary>
        /// Returns true if PriceRecordCollectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordCollectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordCollectionResponse input)
        {
            if (input == null)
                return false;
