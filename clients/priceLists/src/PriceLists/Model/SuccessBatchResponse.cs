...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SuccessBatchResponse :  IEquatable<SuccessBatchResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SuccessBatchResponse" /> class.
        /// </summary>
        public SuccessBatchResponse()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SuccessBatchResponse {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SuccessBatchResponse);
        }

        /// <summary>
        /// Returns true if SuccessBatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SuccessBatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SuccessBatchResponse input)
        {
            if (input == null)
                return false;
