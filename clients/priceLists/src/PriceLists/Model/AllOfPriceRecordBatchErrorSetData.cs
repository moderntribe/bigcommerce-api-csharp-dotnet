...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPriceRecordBatchErrorSetData :  IEquatable<AllOfPriceRecordBatchErrorSetData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPriceRecordBatchErrorSetData" /> class.
        /// </summary>
        public AllOfPriceRecordBatchErrorSetData()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPriceRecordBatchErrorSetData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AllOfPriceRecordBatchErrorSetData);
        }

        /// <summary>
        /// Returns true if AllOfPriceRecordBatchErrorSetData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPriceRecordBatchErrorSetData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPriceRecordBatchErrorSetData input)
        {
            if (input == null)
                return false;
