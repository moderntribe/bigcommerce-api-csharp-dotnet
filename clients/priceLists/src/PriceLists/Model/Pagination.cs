...
namespace PriceLists.Model
{
        ...
        public partial class Pagination :  IEquatable<Pagination>, IValidatableObject
    {
        ...
        public Pagination(int? total = default(int?), int? count = default(int?), int? perPage = default(int?), int? currentPage = default(int?), int? totalPages = default(int?), Pagination1Links links = default(Pagination1Links))
        {
            this.Total = total;
            this.Count = count;
