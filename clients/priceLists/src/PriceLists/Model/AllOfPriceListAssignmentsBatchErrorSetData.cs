...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPriceListAssignmentsBatchErrorSetData :  IEquatable<AllOfPriceListAssignmentsBatchErrorSetData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPriceListAssignmentsBatchErrorSetData" /> class.
        /// </summary>
        public AllOfPriceListAssignmentsBatchErrorSetData()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPriceListAssignmentsBatchErrorSetData {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AllOfPriceListAssignmentsBatchErrorSetData);
        }

        /// <summary>
        /// Returns true if AllOfPriceListAssignmentsBatchErrorSetData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPriceListAssignmentsBatchErrorSetData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPriceListAssignmentsBatchErrorSetData input)
        {
            if (input == null)
                return false;
