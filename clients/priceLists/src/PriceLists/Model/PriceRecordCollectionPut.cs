...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecordCollectionPut : List<Object>,  IEquatable<PriceRecordCollectionPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordCollectionPut" /> class.
        /// </summary>
        public PriceRecordCollectionPut() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordCollectionPut {\n");
        ...
        {
            return this.Equals(input as PriceRecordCollectionPut);
        }

        /// <summary>
        /// Returns true if PriceRecordCollectionPut instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordCollectionPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordCollectionPut input)
        {
            if (input == null)
                return false;
