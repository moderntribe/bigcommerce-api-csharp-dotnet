...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListPut :  IEquatable<PriceListPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListPut" /> class.
        /// </summary>
        public PriceListPut()
        {
        }
        ...
        {
            return this.Equals(input as PriceListPut);
        }

        /// <summary>
        /// Returns true if PriceListPut instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListPut input)
        {
            if (input == null)
                return false;
