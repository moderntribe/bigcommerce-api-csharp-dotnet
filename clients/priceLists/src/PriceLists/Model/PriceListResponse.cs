...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListResponse :  IEquatable<PriceListResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PriceListResponse(AllOfPriceListResponseData data = default(AllOfPriceListResponseData), Object meta = default(Object))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public AllOfPriceListResponseData Data { get; set; }
