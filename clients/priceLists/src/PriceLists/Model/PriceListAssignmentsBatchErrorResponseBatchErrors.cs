...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListAssignmentsBatchErrorResponseBatchErrors :  IEquatable<PriceListAssignmentsBatchErrorResponseBatchErrors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListAssignmentsBatchErrorResponseBatchErrors" /> class.
        /// </summary>
        /// <param name="data">&#x60;Price List Assignments&#x60; object used in GET response..</param>
        /// <param name="fieldErrors">fieldErrors.</param>
        public PriceListAssignmentsBatchErrorResponseBatchErrors(AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData data = default(AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData), Dictionary<string, string> fieldErrors = default(Dictionary<string, string>))
        {
            this.Data = data;
        ...
        /// </summary>
        /// <value>&#x60;Price List Assignments&#x60; object used in GET response.</value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public AllOfPriceListAssignmentsBatchErrorResponseBatchErrorsData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceListAssignmentsBatchErrorResponseBatchErrors {\n");
        ...
        {
            return this.Equals(input as PriceListAssignmentsBatchErrorResponseBatchErrors);
        }

        /// <summary>
        /// Returns true if PriceListAssignmentsBatchErrorResponseBatchErrors instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListAssignmentsBatchErrorResponseBatchErrors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListAssignmentsBatchErrorResponseBatchErrors input)
        {
            if (input == null)
                return false;
