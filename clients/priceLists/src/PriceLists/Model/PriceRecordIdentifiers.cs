...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecordIdentifiers :  IEquatable<PriceRecordIdentifiers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordIdentifiers" /> class.
        /// </summary>
        public PriceRecordIdentifiers()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordIdentifiers {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PriceRecordIdentifiers);
        }

        /// <summary>
        /// Returns true if PriceRecordIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordIdentifiers input)
        {
            if (input == null)
                return false;
