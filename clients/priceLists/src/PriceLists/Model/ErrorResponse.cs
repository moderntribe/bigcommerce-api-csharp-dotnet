...
namespace PriceLists.Model
{
        ...
        public partial class ErrorResponse :  IEquatable<ErrorResponse>, IValidatableObject
    {
        ...
        public ErrorResponse(Dictionary<string, string> errors = default(Dictionary<string, string>), string instance = default(string), int? status = default(int?), string title = default(string), string type = default(string))
        {
            this.Errors = errors;
