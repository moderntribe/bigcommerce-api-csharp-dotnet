...
namespace PriceLists.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateBatchPriceListAssignmentsRequest : List<Body>,  IEquatable<CreateBatchPriceListAssignmentsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateBatchPriceListAssignmentsRequest" /> class.
        /// </summary>
        public CreateBatchPriceListAssignmentsRequest() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateBatchPriceListAssignmentsRequest {\n");
        ...
        {
            return this.Equals(input as CreateBatchPriceListAssignmentsRequest);
        }

        /// <summary>
        /// Returns true if CreateBatchPriceListAssignmentsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateBatchPriceListAssignmentsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateBatchPriceListAssignmentsRequest input)
        {
            if (input == null)
                return false;
