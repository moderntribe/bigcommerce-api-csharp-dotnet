...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecordBatchItem :  IEquatable<PriceRecordBatchItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordBatchItem" /> class.
        /// </summary>
        ...
        public PriceRecordBatchItem(double? price = default(double?), double? salePrice = default(double?), double? retailPrice = default(double?), double? mapPrice = default(double?), List<BulkPricingTier> bulkPricingTiers = default(List<BulkPricingTier>), string sku = default(string))
        {
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordBatchItem {\n");
        ...
        {
            return this.Equals(input as PriceRecordBatchItem);
        }

        /// <summary>
        /// Returns true if PriceRecordBatchItem instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordBatchItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordBatchItem input)
        {
            if (input == null)
                return false;
