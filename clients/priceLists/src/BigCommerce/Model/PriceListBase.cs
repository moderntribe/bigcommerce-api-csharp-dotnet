...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListBase :  IEquatable<PriceListBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListBase" /> class.
        /// </summary>
        ...
        public PriceListBase(string name = default(string), bool? active = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PriceListBase and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as PriceListBase);
        }

        /// <summary>
        /// Returns true if PriceListBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListBase input)
        {
            if (input == null)
                return false;
