...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecord :  IEquatable<PriceRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecord" /> class.
        /// </summary>
        ...
        public PriceRecord(double? price = default(double?), double? salePrice = default(double?), double? retailPrice = default(double?), double? mapPrice = default(double?), List<BulkPricingTier> bulkPricingTiers = default(List<BulkPricingTier>), string sku = default(string))
        {
            this.Price = price;
        ...
        {
            return this.Equals(input as PriceRecord);
        }

        /// <summary>
        /// Returns true if PriceRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecord input)
        {
            if (input == null)
                return false;
