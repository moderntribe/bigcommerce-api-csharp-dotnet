...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssignmentsForRequest :  IEquatable<AssignmentsForRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssignmentsForRequest" /> class.
        /// </summary>
        /// <param name="customerGroupId">Customer group id for assignment..</param>
        /// <param name="priceListId">Pricelist id for assignment. (required).</param>
        /// <param name="channelId">Channel ID for assignment.</param>
        public AssignmentsForRequest(int? customerGroupId = default(int?), int? priceListId = default(int?), int? channelId = default(int?))
        {
            // to ensure "priceListId" is required (not null)
            if (priceListId == null)
            {
                throw new InvalidDataException("priceListId is a required property for AssignmentsForRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssignmentsForRequest {\n");
        ...
        {
            return this.Equals(input as AssignmentsForRequest);
        }

        /// <summary>
        /// Returns true if AssignmentsForRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AssignmentsForRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssignmentsForRequest input)
        {
            if (input == null)
                return false;
