...
namespace BigCommerce.Model
{
        ...
        public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(List<AssignmentsForGetResponseData> data = default(List<AssignmentsForGetResponseData>), CollectionMeta meta = default(CollectionMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
