...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListAssignmentsBatchErrorResponse :  IEquatable<PriceListAssignmentsBatchErrorResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListAssignmentsBatchErrorResponse" /> class.
        /// </summary>
        /// <param name="batchErrors">batchErrors.</param>
        public PriceListAssignmentsBatchErrorResponse(List<PriceListAssignmentsBatchErrorResponseBatchErrors> batchErrors = default(List<PriceListAssignmentsBatchErrorResponseBatchErrors>))
        {
        ...
        public List<PriceListAssignmentsBatchErrorResponseBatchErrors> BatchErrors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceListAssignmentsBatchErrorResponse {\n");
        ...
        {
            return this.Equals(input as PriceListAssignmentsBatchErrorResponse);
        }

        /// <summary>
        /// Returns true if PriceListAssignmentsBatchErrorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListAssignmentsBatchErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListAssignmentsBatchErrorResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.BatchErrors == input.BatchErrors ||
                    this.BatchErrors != null &&
                    input.BatchErrors != null &&
                    this.BatchErrors.SequenceEqual(input.BatchErrors)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BatchErrors != null)
                    hashCode = hashCode * 59 + this.BatchErrors.GetHashCode();
                return hashCode;
            }
        }
