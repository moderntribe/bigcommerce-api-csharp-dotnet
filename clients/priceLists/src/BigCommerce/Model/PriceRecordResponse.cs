...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecordResponse :  IEquatable<PriceRecordResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordResponse" /> class.
        /// </summary>
        /// <param name="data">The Price Record object..</param>
        /// <param name="meta">Empty meta object; may be used later..</param>
        public PriceRecordResponse(AllOfPriceRecordResponseData data = default(AllOfPriceRecordResponseData), Object meta = default(Object))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>The Price Record object.</value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public AllOfPriceRecordResponseData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordResponse {\n");
        ...
        {
            return this.Equals(input as PriceRecordResponse);
        }

        /// <summary>
        /// Returns true if PriceRecordResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordResponse input)
        {
            if (input == null)
                return false;
