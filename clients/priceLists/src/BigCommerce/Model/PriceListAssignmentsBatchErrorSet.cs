...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListAssignmentsBatchErrorSet :  IEquatable<PriceListAssignmentsBatchErrorSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListAssignmentsBatchErrorSet" /> class.
        /// </summary>
        /// <param name="data">&#x60;Price List Assignments&#x60; object used in GET response..</param>
        /// <param name="fieldErrors">fieldErrors.</param>
        public PriceListAssignmentsBatchErrorSet(AllOfPriceListAssignmentsBatchErrorSetData data = default(AllOfPriceListAssignmentsBatchErrorSetData), Dictionary<string, string> fieldErrors = default(Dictionary<string, string>))
        {
            this.Data = data;
        ...
        public AllOfPriceListAssignmentsBatchErrorSetData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceListAssignmentsBatchErrorSet {\n");
        ...
        {
            return this.Equals(input as PriceListAssignmentsBatchErrorSet);
        }

        /// <summary>
        /// Returns true if PriceListAssignmentsBatchErrorSet instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListAssignmentsBatchErrorSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListAssignmentsBatchErrorSet input)
        {
            if (input == null)
                return false;
