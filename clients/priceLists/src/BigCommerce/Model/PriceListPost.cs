...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListPost :  IEquatable<PriceListPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListPost" /> class.
        /// </summary>
        public PriceListPost()
        {
        }
        ...
        {
            return this.Equals(input as PriceListPost);
        }

        /// <summary>
        /// Returns true if PriceListPost instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListPost input)
        {
            if (input == null)
                return false;
