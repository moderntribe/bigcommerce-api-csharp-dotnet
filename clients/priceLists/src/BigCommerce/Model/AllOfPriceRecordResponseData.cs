...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPriceRecordResponseData :  IEquatable<AllOfPriceRecordResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPriceRecordResponseData" /> class.
        /// </summary>
        ...
        public AllOfPriceRecordResponseData(double? price = default(double?), double? salePrice = default(double?), double? retailPrice = default(double?), double? mapPrice = default(double?), List<Object> bulkPricingTiers = default(List<Object>), string sku = default(string))
        {
            this.Price = price;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPriceRecordResponseData {\n");
        ...
        {
            return this.Equals(input as AllOfPriceRecordResponseData);
        }

        /// <summary>
        /// Returns true if AllOfPriceRecordResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPriceRecordResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPriceRecordResponseData input)
        {
            if (input == null)
                return false;
