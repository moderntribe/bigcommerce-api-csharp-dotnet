...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecordBatchErrorSet :  IEquatable<PriceRecordBatchErrorSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordBatchErrorSet" /> class.
        /// </summary>
        /// <param name="data">Price Record object used in batch create or update..</param>
        /// <param name="fieldErrors">fieldErrors.</param>
        public PriceRecordBatchErrorSet(AllOfPriceRecordBatchErrorSetData data = default(AllOfPriceRecordBatchErrorSetData), Dictionary<string, string> fieldErrors = default(Dictionary<string, string>))
        {
            this.Data = data;
        ...
        /// </summary>
        /// <value>Price Record object used in batch create or update.</value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public AllOfPriceRecordBatchErrorSetData Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordBatchErrorSet {\n");
        ...
        {
            return this.Equals(input as PriceRecordBatchErrorSet);
        }

        /// <summary>
        /// Returns true if PriceRecordBatchErrorSet instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordBatchErrorSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordBatchErrorSet input)
        {
            if (input == null)
                return false;
