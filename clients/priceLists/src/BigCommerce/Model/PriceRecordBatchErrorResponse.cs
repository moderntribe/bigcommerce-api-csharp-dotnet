...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecordBatchErrorResponse :  IEquatable<PriceRecordBatchErrorResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordBatchErrorResponse" /> class.
        /// </summary>
        /// <param name="batchErrors">batchErrors.</param>
        public PriceRecordBatchErrorResponse(List<PriceRecordBatchErrorSet> batchErrors = default(List<PriceRecordBatchErrorSet>))
        {
        ...
        public List<PriceRecordBatchErrorSet> BatchErrors { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordBatchErrorResponse {\n");
        ...
        {
            return this.Equals(input as PriceRecordBatchErrorResponse);
        }

        /// <summary>
        /// Returns true if PriceRecordBatchErrorResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordBatchErrorResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordBatchErrorResponse input)
        {
            if (input == null)
                return false;
