...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceRecordPut :  IEquatable<PriceRecordPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceRecordPut" /> class.
        /// </summary>
        public PriceRecordPut()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceRecordPut {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PriceRecordPut);
        }

        /// <summary>
        /// Returns true if PriceRecordPut instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceRecordPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceRecordPut input)
        {
            if (input == null)
                return false;
