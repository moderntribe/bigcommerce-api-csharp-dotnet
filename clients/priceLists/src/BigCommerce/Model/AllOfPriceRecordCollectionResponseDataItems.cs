...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPriceRecordCollectionResponseDataItems :  IEquatable<AllOfPriceRecordCollectionResponseDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPriceRecordCollectionResponseDataItems" /> class.
        /// </summary>
        ...
        public AllOfPriceRecordCollectionResponseDataItems(double? price = default(double?), double? salePrice = default(double?), double? retailPrice = default(double?), double? mapPrice = default(double?), List<Object> bulkPricingTiers = default(List<Object>), string sku = default(string))
        {
            this.Price = price;
        ...
        public List<Object> BulkPricingTiers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPriceRecordCollectionResponseDataItems {\n");
        ...
        {
            return this.Equals(input as AllOfPriceRecordCollectionResponseDataItems);
        }

        /// <summary>
        /// Returns true if AllOfPriceRecordCollectionResponseDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPriceRecordCollectionResponseDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPriceRecordCollectionResponseDataItems input)
        {
            if (input == null)
                return false;
