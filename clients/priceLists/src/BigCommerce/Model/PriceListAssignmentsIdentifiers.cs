...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PriceListAssignmentsIdentifiers :  IEquatable<PriceListAssignmentsIdentifiers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceListAssignmentsIdentifiers" /> class.
        /// </summary>
        public PriceListAssignmentsIdentifiers()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PriceListAssignmentsIdentifiers {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PriceListAssignmentsIdentifiers);
        }

        /// <summary>
        /// Returns true if PriceListAssignmentsIdentifiers instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceListAssignmentsIdentifiers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceListAssignmentsIdentifiers input)
        {
            if (input == null)
                return false;
