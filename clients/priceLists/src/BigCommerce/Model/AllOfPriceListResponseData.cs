...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPriceListResponseData :  IEquatable<AllOfPriceListResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPriceListResponseData" /> class.
        /// </summary>
        ...
        public AllOfPriceListResponseData(string name = default(string), bool? active = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AllOfPriceListResponseData and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPriceListResponseData {\n");
        ...
        {
            return this.Equals(input as AllOfPriceListResponseData);
        }

        /// <summary>
        /// Returns true if AllOfPriceListResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPriceListResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPriceListResponseData input)
        {
            if (input == null)
                return false;
