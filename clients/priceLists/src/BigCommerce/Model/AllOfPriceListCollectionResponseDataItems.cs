...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPriceListCollectionResponseDataItems :  IEquatable<AllOfPriceListCollectionResponseDataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPriceListCollectionResponseDataItems" /> class.
        /// </summary>
        /// <param name="name">The unique name of the Price List. Required in /POST.   (required).</param>
        /// <param name="active">Whether or not this &#x60;Price List&#x60; and its prices are active.  Defaults to &#x60;true&#x60;. .</param>
        public AllOfPriceListCollectionResponseDataItems(string name = default(string), bool? active = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for AllOfPriceListCollectionResponseDataItems and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>The unique name of the Price List. Required in /POST.  </value>
        ...
        /// </summary>
        /// <value>Whether or not this &#x60;Price List&#x60; and its prices are active.  Defaults to &#x60;true&#x60;. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPriceListCollectionResponseDataItems {\n");
        ...
        {
            return this.Equals(input as AllOfPriceListCollectionResponseDataItems);
        }

        /// <summary>
        /// Returns true if AllOfPriceListCollectionResponseDataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPriceListCollectionResponseDataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPriceListCollectionResponseDataItems input)
        {
            if (input == null)
                return false;
