...
namespace BigCommerce.Model
{
        ...
        public partial class PriceList :  IEquatable<PriceList>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">The unique numeric ID of the &#x60;Price List&#x60;; increments sequentially. .</param>
        /// <param name="dateCreated">The date on which the &#x60;Price List&#x60; was created. .</param>
        /// <param name="dateModified">The date on which the &#x60;Price List&#x60; was created. .</param>
        ...
        public PriceList(int? id = default(int?), DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?), string name = default(string), bool? active = default(bool?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PriceList and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>The unique numeric ID of the &#x60;Price List&#x60;; increments sequentially. </value>
        ...
        /// </summary>
        /// <value>The date on which the &#x60;Price List&#x60; was created. </value>
