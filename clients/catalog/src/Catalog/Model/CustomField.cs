...
namespace Catalog.Model
{
        ...
        public partial class CustomField :  IEquatable<CustomField>, IValidatableObject
    {
        ...
        public CustomField(int? id = default(int?), string name = default(string), string value = default(string))
        {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CustomField and cannot be null");
            }
            else
            {
                this.Value = value;
