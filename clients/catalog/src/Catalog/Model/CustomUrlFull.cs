...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CustomUrlFull :  IEquatable<CustomUrlFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomUrlFull" /> class.
        /// </summary>
        ...
        public CustomUrlFull(bool? isCustomized = default(bool?), string url = default(string))
        {
        ...
        {
            return this.Equals(input as CustomUrlFull);
        }

        /// <summary>
        /// Returns true if CustomUrlFull instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomUrlFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomUrlFull input)
        {
            if (input == null)
                return false;
