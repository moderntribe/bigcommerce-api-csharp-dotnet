...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfMetafieldResponse1Data :  IEquatable<AllOfMetafieldResponse1Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfMetafieldResponse1Data" /> class.
        /// </summary>
        ...
        public AllOfMetafieldResponse1Data(DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfMetafieldResponse1Data {\n");
        ...
        {
            return this.Equals(input as AllOfMetafieldResponse1Data);
        }

        /// <summary>
        /// Returns true if AllOfMetafieldResponse1Data instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfMetafieldResponse1Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfMetafieldResponse1Data input)
        {
            if (input == null)
                return false;
