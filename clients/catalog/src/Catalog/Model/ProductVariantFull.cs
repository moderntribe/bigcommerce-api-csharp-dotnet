...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductVariantFull :  IEquatable<ProductVariantFull>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProductVariantFull);
        }

        /// <summary>
        /// Returns true if ProductVariantFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVariantFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVariantFull input)
        {
            if (input == null)
                return false;
