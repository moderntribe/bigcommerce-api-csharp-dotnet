...
namespace Catalog.Model
{
        ...
        public partial class Metafield :  IEquatable<Metafield>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="createdAt">Date and time of the metafield&#x27;s creation. Read-Only. .</param>
        ...
        /// <param name="permissionSet">Determines whether the field is completely private to the app that owns the field (&#x60;app_only&#x60;), or visible to other API consumers (&#x60;read&#x60;), or completely open for reading and writing to other apps (&#x60;write&#x60;). Required for POST.  (required).</param>
        ...
        /// <param name="updatedAt">Date and time when the metafield was last updated. Read-Only. .</param>
        /// <param name="value">The value of the field, for example: &#x60;1&#x60;, &#x60;blue&#x60;. Required for POST.  (required).</param>
        public Metafield(DateTime? createdAt = default(DateTime?), string description = default(string), int? id = default(int?), string key = default(string), string _namespace = default(string), PermissionSetEnum permissionSet = default(PermissionSetEnum), int? resourceId = default(int?), ResourceTypeEnum? resourceType = default(ResourceTypeEnum?), DateTime? updatedAt = default(DateTime?), string value = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for Metafield and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("permissionSet is a required property for Metafield and cannot be null");
            }
            else
            {
