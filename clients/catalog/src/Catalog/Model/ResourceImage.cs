...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ResourceImage :  IEquatable<ResourceImage>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ResourceImage);
        }

        /// <summary>
        /// Returns true if ResourceImage instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceImage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceImage input)
        {
            if (input == null)
                return false;
