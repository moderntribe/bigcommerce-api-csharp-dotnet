...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ComplexRule1 :  IEquatable<ComplexRule1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplexRule1" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ComplexRule1);
        }

        /// <summary>
        /// Returns true if ComplexRule1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplexRule1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplexRule1 input)
        {
            if (input == null)
                return false;
