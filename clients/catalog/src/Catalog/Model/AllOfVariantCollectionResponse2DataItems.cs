...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfVariantCollectionResponse2DataItems :  IEquatable<AllOfVariantCollectionResponse2DataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfVariantCollectionResponse2DataItems" /> class.
        /// </summary>
        ...
        public AllOfVariantCollectionResponse2DataItems(double? calculatedPrice = default(double?), int? id = default(int?), List<Object> optionValues = default(List<Object>), int? productId = default(int?), string sku = default(string), int? skuId = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfVariantCollectionResponse2DataItems {\n");
        ...
        {
            return this.Equals(input as AllOfVariantCollectionResponse2DataItems);
        }

        /// <summary>
        /// Returns true if AllOfVariantCollectionResponse2DataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfVariantCollectionResponse2DataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfVariantCollectionResponse2DataItems input)
        {
            if (input == null)
                return false;
