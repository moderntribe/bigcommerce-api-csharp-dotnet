...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetafieldPut2 :  IEquatable<MetafieldPut2>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetafieldPut2" /> class.
        /// </summary>
        ...
        public MetafieldPut2(DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?), string description = default(string), int? id = default(int?), string key = default(string), string _namespace = default(string), PermissionSetEnum permissionSet = default(PermissionSetEnum), int? resourceId = default(int?), ResourceTypeEnum? resourceType = default(ResourceTypeEnum?), string value = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MetafieldPut2 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("permissionSet is a required property for MetafieldPut2 and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for MetafieldPut2 and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as MetafieldPut2);
        }

        /// <summary>
        /// Returns true if MetafieldPut2 instances are equal
        /// </summary>
        /// <param name="input">Instance of MetafieldPut2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetafieldPut2 input)
        {
            if (input == null)
                return false;
