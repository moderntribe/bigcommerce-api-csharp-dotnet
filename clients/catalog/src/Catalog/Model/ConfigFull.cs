...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConfigFull :  IEquatable<ConfigFull>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigFull" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ConfigFull);
        }

        /// <summary>
        /// Returns true if ConfigFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigFull input)
        {
            if (input == null)
                return false;
