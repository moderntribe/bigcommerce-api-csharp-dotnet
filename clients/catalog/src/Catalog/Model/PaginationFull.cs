...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PaginationFull :  IEquatable<PaginationFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginationFull" /> class.
        /// </summary>
        ...
        public PaginationFull(int? count = default(int?), int? currentPage = default(int?), PaginationFull1Links links = default(PaginationFull1Links), int? perPage = default(int?), int? total = default(int?), int? totalPages = default(int?))
        {
            this.Count = count;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginationFull {\n");
        ...
        {
            return this.Equals(input as PaginationFull);
        }

        /// <summary>
        /// Returns true if PaginationFull instances are equal
        /// </summary>
        /// <param name="input">Instance of PaginationFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginationFull input)
        {
            if (input == null)
                return false;
