...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BulkPricingRule :  IEquatable<BulkPricingRule>, IValidatableObject
    {
        /// <summary>
        ...
        public BulkPricingRule(int? amount = default(int?), int? id = default(int?), int? quantityMax = default(int?), int? quantityMin = default(int?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for BulkPricingRule and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (quantityMax == null)
            {
                throw new InvalidDataException("quantityMax is a required property for BulkPricingRule and cannot be null");
            }
            else
            {
            ...
            if (quantityMin == null)
            {
                throw new InvalidDataException("quantityMin is a required property for BulkPricingRule and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BulkPricingRule and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkPricingRule {\n");
        ...
        {
            return this.Equals(input as BulkPricingRule);
        }

        /// <summary>
        /// Returns true if BulkPricingRule instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkPricingRule to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkPricingRule input)
        {
            if (input == null)
                return false;
