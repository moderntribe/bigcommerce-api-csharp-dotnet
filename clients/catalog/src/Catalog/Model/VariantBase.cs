...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VariantBase :  IEquatable<VariantBase>, IValidatableObject
    {
        /// <summary>
        ...
        public VariantBase(string binPickingNumber = default(string), double? costPrice = default(double?), double? depth = default(double?), double? fixedCostShippingPrice = default(double?), double? height = default(double?), int? inventoryLevel = default(int?), int? inventoryWarningLevel = default(int?), bool? isFreeShipping = default(bool?), double? price = default(double?), bool? purchasingDisabled = default(bool?), string purchasingDisabledMessage = default(string), double? retailPrice = default(double?), double? salePrice = default(double?), string upc = default(string), double? weight = default(double?), double? width = default(double?))
        {
        ...
        {
            return this.Equals(input as VariantBase);
        }

        /// <summary>
        /// Returns true if VariantBase instances are equal
        /// </summary>
        /// <param name="input">Instance of VariantBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VariantBase input)
        {
            if (input == null)
                return false;
