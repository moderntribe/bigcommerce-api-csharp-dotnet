...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BulkPricingRuleFull :  IEquatable<BulkPricingRuleFull>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BulkPricingRuleFull);
        }

        /// <summary>
        /// Returns true if BulkPricingRuleFull instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkPricingRuleFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkPricingRuleFull input)
        {
            if (input == null)
                return false;
