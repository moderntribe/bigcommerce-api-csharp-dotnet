...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetafieldFull :  IEquatable<MetafieldFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetafieldFull" /> class.
        /// </summary>
        ...
        public MetafieldFull(DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?))
        {
        ...
        {
            return this.Equals(input as MetafieldFull);
        }

        /// <summary>
        /// Returns true if MetafieldFull instances are equal
        /// </summary>
        /// <param name="input">Instance of MetafieldFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetafieldFull input)
        {
            if (input == null)
                return false;
