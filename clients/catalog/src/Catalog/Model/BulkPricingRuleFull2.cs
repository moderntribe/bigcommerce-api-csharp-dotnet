...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BulkPricingRuleFull2 :  IEquatable<BulkPricingRuleFull2>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkPricingRuleFull2" /> class.
        /// </summary>
        ...
        public BulkPricingRuleFull2(int? amount = default(int?), int? id = default(int?), int? quantityMax = default(int?), int? quantityMin = default(int?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for BulkPricingRuleFull2 and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (quantityMax == null)
            {
                throw new InvalidDataException("quantityMax is a required property for BulkPricingRuleFull2 and cannot be null");
            }
            else
            {
            ...
            if (quantityMin == null)
            {
                throw new InvalidDataException("quantityMin is a required property for BulkPricingRuleFull2 and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BulkPricingRuleFull2 and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkPricingRuleFull2 {\n");
        ...
        {
            return this.Equals(input as BulkPricingRuleFull2);
        }

        /// <summary>
        /// Returns true if BulkPricingRuleFull2 instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkPricingRuleFull2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkPricingRuleFull2 input)
        {
            if (input == null)
                return false;
