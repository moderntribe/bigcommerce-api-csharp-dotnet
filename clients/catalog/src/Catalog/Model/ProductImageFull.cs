...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductImageFull :  IEquatable<ProductImageFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductImageFull" /> class.
        /// </summary>
        ...
        public ProductImageFull(DateTime? dateModified = default(DateTime?), int? id = default(int?), int? productId = default(int?), string urlStandard = default(string), string urlThumbnail = default(string), string urlTiny = default(string), string urlZoom = default(string))
        {
        ...
        {
            return this.Equals(input as ProductImageFull);
        }

        /// <summary>
        /// Returns true if ProductImageFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductImageFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductImageFull input)
        {
            if (input == null)
                return false;
