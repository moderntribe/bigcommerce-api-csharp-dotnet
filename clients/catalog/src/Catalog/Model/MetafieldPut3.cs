...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetafieldPut3 :  IEquatable<MetafieldPut3>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetafieldPut3" /> class.
        /// </summary>
        ...
        public MetafieldPut3(DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?), string description = default(string), int? id = default(int?), string key = default(string), string _namespace = default(string), PermissionSetEnum permissionSet = default(PermissionSetEnum), int? resourceId = default(int?), ResourceTypeEnum? resourceType = default(ResourceTypeEnum?), string value = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MetafieldPut3 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("permissionSet is a required property for MetafieldPut3 and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for MetafieldPut3 and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as MetafieldPut3);
        }

        /// <summary>
        /// Returns true if MetafieldPut3 instances are equal
        /// </summary>
        /// <param name="input">Instance of MetafieldPut3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetafieldPut3 input)
        {
            if (input == null)
                return false;
