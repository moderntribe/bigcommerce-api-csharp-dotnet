...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AdjustersFull1 :  IEquatable<AdjustersFull1>, IValidatableObject
    {
        /// <summary>
        ...
        public AdjustersFull1(string imageUrl = default(string), Adjuster price = default(Adjuster), AdjustersFullPurchasingDisabled purchasingDisabled = default(AdjustersFullPurchasingDisabled), Adjuster weight = default(Adjuster))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdjustersFull1 {\n");
        ...
        {
            return this.Equals(input as AdjustersFull1);
        }

        /// <summary>
        /// Returns true if AdjustersFull1 instances are equal
        /// </summary>
        /// <param name="input">Instance of AdjustersFull1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdjustersFull1 input)
        {
            if (input == null)
                return false;
