...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OptionConfig :  IEquatable<OptionConfig>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionConfig" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as OptionConfig);
        }

        /// <summary>
        /// Returns true if OptionConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionConfig input)
        {
            if (input == null)
                return false;
