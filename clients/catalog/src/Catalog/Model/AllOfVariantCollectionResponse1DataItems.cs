...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfVariantCollectionResponse1DataItems :  IEquatable<AllOfVariantCollectionResponse1DataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfVariantCollectionResponse1DataItems" /> class.
        /// </summary>
        ...
        public AllOfVariantCollectionResponse1DataItems(double? calculatedPrice = default(double?), int? id = default(int?), List<Object> optionValues = default(List<Object>), int? productId = default(int?), string sku = default(string), int? skuId = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfVariantCollectionResponse1DataItems {\n");
        ...
        {
            return this.Equals(input as AllOfVariantCollectionResponse1DataItems);
        }

        /// <summary>
        /// Returns true if AllOfVariantCollectionResponse1DataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfVariantCollectionResponse1DataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfVariantCollectionResponse1DataItems input)
        {
            if (input == null)
                return false;
