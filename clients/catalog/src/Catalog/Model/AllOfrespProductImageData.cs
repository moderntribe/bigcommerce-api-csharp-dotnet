...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfrespProductImageData :  IEquatable<AllOfrespProductImageData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfrespProductImageData" /> class.
        /// </summary>
        ...
        public AllOfrespProductImageData(DateTime? dateModified = default(DateTime?), int? id = default(int?), int? productId = default(int?), string urlStandard = default(string), string urlThumbnail = default(string), string urlTiny = default(string), string urlZoom = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfrespProductImageData {\n");
        ...
        {
            return this.Equals(input as AllOfrespProductImageData);
        }

        /// <summary>
        /// Returns true if AllOfrespProductImageData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfrespProductImageData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfrespProductImageData input)
        {
            if (input == null)
                return false;
