...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductImagePost1 :  IEquatable<ProductImagePost1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductImagePost1" /> class.
        /// </summary>
        ...
        public ProductImagePost1(string imageFile = default(string), string imageUrl = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductImagePost1 {\n");
        ...
        {
            return this.Equals(input as ProductImagePost1);
        }

        /// <summary>
        /// Returns true if ProductImagePost1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductImagePost1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductImagePost1 input)
        {
            if (input == null)
                return false;
