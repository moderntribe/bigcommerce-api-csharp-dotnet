...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfProductVideoResponseData :  IEquatable<AllOfProductVideoResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfProductVideoResponseData" /> class.
        /// </summary>
        ...
        public AllOfProductVideoResponseData(int? id = default(int?), string length = default(string), int? productId = default(int?), string videoId = default(string))
        {
            this.Id = id;
            this.Length = length;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfProductVideoResponseData {\n");
        ...
        {
            return this.Equals(input as AllOfProductVideoResponseData);
        }

        /// <summary>
        /// Returns true if AllOfProductVideoResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfProductVideoResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfProductVideoResponseData input)
        {
            if (input == null)
                return false;
