...
namespace Catalog.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ComplexRuleCondition :  IEquatable<ComplexRuleCondition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplexRuleCondition" /> class.
        /// </summary>
        ...
        public ComplexRuleCondition(int? combinationId = default(int?), int? id = default(int?), int? modifierId = default(int?), int? modifierValueId = default(int?), int? ruleId = default(int?), int? variantId = default(int?))
        {
            // to ensure "modifierId" is required (not null)
            if (modifierId == null)
            {
                throw new InvalidDataException("modifierId is a required property for ComplexRuleCondition and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("modifierValueId is a required property for ComplexRuleCondition and cannot be null");
            }
            else
            {
            ...
            if (variantId == null)
            {
                throw new InvalidDataException("variantId is a required property for ComplexRuleCondition and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ComplexRuleCondition {\n");
        ...
        {
            return this.Equals(input as ComplexRuleCondition);
        }

        /// <summary>
        /// Returns true if ComplexRuleCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplexRuleCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplexRuleCondition input)
        {
            if (input == null)
                return false;
