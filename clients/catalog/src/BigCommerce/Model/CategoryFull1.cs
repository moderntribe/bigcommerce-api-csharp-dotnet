...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CategoryFull1 :  IEquatable<CategoryFull1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoryFull1" /> class.
        /// </summary>
        ...
        public CategoryFull1(CustomUrlCategory customUrl = default(CustomUrlCategory), DefaultProductSortEnum? defaultProductSort = default(DefaultProductSortEnum?), string description = default(string), int? id = default(int?), string imageUrl = default(string), bool? isVisible = default(bool?), string layoutFile = default(string), string metaDescription = default(string), List<string> metaKeywords = default(List<string>), string name = default(string), string pageTitle = default(string), int? parentId = default(int?), string searchKeywords = default(string), int? sortOrder = default(int?), int? views = default(int?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CategoryFull1 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (parentId == null)
            {
                throw new InvalidDataException("parentId is a required property for CategoryFull1 and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CategoryFull1);
        }

        /// <summary>
        /// Returns true if CategoryFull1 instances are equal
        /// </summary>
        /// <param name="input">Instance of CategoryFull1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoryFull1 input)
        {
            if (input == null)
                return false;
