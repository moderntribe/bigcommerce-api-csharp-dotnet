...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Brand2 :  IEquatable<Brand2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Brand2" /> class.
        /// </summary>
        ...
        public Brand2(CustomUrlBrand customUrl = default(CustomUrlBrand), int? id = default(int?), string imageUrl = default(string), string metaDescription = default(string), List<string> metaKeywords = default(List<string>), string name = default(string), string pageTitle = default(string), string searchKeywords = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Brand2 and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as Brand2);
        }

        /// <summary>
        /// Returns true if Brand2 instances are equal
        /// </summary>
        /// <param name="input">Instance of Brand2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Brand2 input)
        {
            if (input == null)
                return false;
