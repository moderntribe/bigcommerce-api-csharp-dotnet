...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductVariantPost :  IEquatable<ProductVariantPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVariantPost" /> class.
        /// </summary>
        ...
        public ProductVariantPost(List<Object> optionValues = default(List<Object>), int? productId = default(int?), string sku = default(string))
        {
        ...
        {
            return this.Equals(input as ProductVariantPost);
        }

        /// <summary>
        /// Returns true if ProductVariantPost instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVariantPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVariantPost input)
        {
            if (input == null)
                return false;
