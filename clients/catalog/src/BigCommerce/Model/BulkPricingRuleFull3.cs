...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BulkPricingRuleFull3 :  IEquatable<BulkPricingRuleFull3>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BulkPricingRuleFull3" /> class.
        /// </summary>
        ...
        public BulkPricingRuleFull3(int? amount = default(int?), int? id = default(int?), int? quantityMax = default(int?), int? quantityMin = default(int?), TypeEnum type = default(TypeEnum))
        {
            // to ensure "amount" is required (not null)
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for BulkPricingRuleFull3 and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (quantityMax == null)
            {
                throw new InvalidDataException("quantityMax is a required property for BulkPricingRuleFull3 and cannot be null");
            }
            else
            {
            ...
            if (quantityMin == null)
            {
                throw new InvalidDataException("quantityMin is a required property for BulkPricingRuleFull3 and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BulkPricingRuleFull3 and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BulkPricingRuleFull3 {\n");
        ...
        {
            return this.Equals(input as BulkPricingRuleFull3);
        }

        /// <summary>
        /// Returns true if BulkPricingRuleFull3 instances are equal
        /// </summary>
        /// <param name="input">Instance of BulkPricingRuleFull3 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BulkPricingRuleFull3 input)
        {
            if (input == null)
                return false;
