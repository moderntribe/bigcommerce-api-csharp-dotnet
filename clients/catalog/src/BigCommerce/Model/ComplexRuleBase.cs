...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ComplexRuleBase :  IEquatable<ComplexRuleBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplexRuleBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ComplexRuleBase);
        }

        /// <summary>
        /// Returns true if ComplexRuleBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplexRuleBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplexRuleBase input)
        {
            if (input == null)
                return false;
