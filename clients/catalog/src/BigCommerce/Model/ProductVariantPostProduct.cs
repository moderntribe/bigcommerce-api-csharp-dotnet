...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductVariantPostProduct :  IEquatable<ProductVariantPostProduct>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVariantPostProduct" /> class.
        /// </summary>
        /// <param name="optionValues">optionValues.</param>
        /// <param name="sku">sku.</param>
        public ProductVariantPostProduct(List<Object> optionValues = default(List<Object>), string sku = default(string))
        {
        ...
        {
            return this.Equals(input as ProductVariantPostProduct);
        }

        /// <summary>
        /// Returns true if ProductVariantPostProduct instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVariantPostProduct to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVariantPostProduct input)
        {
            if (input == null)
                return false;
