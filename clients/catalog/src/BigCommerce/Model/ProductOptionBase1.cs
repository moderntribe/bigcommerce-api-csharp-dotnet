...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductOptionBase1 :  IEquatable<ProductOptionBase1>, IValidatableObject
    {
        /// <summary>
        ...
        public AllOfproductOptionBase1OptionValues OptionValues { get; set; }
        ...
        {
            return this.Equals(input as ProductOptionBase1);
        }

        /// <summary>
        /// Returns true if ProductOptionBase1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductOptionBase1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductOptionBase1 input)
        {
            if (input == null)
                return false;
