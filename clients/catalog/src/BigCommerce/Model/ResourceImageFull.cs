...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ResourceImageFull :  IEquatable<ResourceImageFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceImageFull" /> class.
        /// </summary>
        /// <param name="imageUrl">A public URL for a GIF, JPEG, or PNG image. Limit of 8MB per file.  .</param>
        public ResourceImageFull(string imageUrl = default(string))
        {
        ...
        {
            return this.Equals(input as ResourceImageFull);
        }

        /// <summary>
        /// Returns true if ResourceImageFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceImageFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceImageFull input)
        {
            if (input == null)
                return false;
