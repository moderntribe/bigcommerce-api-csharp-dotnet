...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BrandFull1 :  IEquatable<BrandFull1>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as BrandFull1);
        }

        /// <summary>
        /// Returns true if BrandFull1 instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandFull1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandFull1 input)
        {
            if (input == null)
                return false;
