...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ResourceImage1 :  IEquatable<ResourceImage1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceImage1" /> class.
        /// </summary>
        /// <param name="imageUrl">A public URL for a GIF, JPEG, or PNG image. Limit of 8MB per file.  .</param>
        public ResourceImage1(string imageUrl = default(string))
        {
        ...
        {
            return this.Equals(input as ResourceImage1);
        }

        /// <summary>
        /// Returns true if ResourceImage1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceImage1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceImage1 input)
        {
            if (input == null)
                return false;
