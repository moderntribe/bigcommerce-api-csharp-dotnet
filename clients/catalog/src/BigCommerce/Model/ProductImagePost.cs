...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductImagePost :  IEquatable<ProductImagePost>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ProductImagePost);
        }

        /// <summary>
        /// Returns true if ProductImagePost instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductImagePost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductImagePost input)
        {
            if (input == null)
                return false;
