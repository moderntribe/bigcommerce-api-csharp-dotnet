...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CustomUrlBrand :  IEquatable<CustomUrlBrand>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomUrlBrand" /> class.
        /// </summary>
        /// <param name="isCustomized">Returns &#x60;true&#x60; if the URL has been changed from its default state (the auto-assigned URL that BigCommerce provides). .</param>
        /// <param name="url">Brand URL on the storefront. .</param>
        public CustomUrlBrand(bool? isCustomized = default(bool?), string url = default(string))
        {
        ...
        /// </summary>
        /// <value>Brand URL on the storefront. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomUrlBrand {\n");
        ...
        {
            return this.Equals(input as CustomUrlBrand);
        }

        /// <summary>
        /// Returns true if CustomUrlBrand instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomUrlBrand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomUrlBrand input)
        {
            if (input == null)
                return false;
