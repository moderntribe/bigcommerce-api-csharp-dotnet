...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfProductImageResponse1Data :  IEquatable<AllOfProductImageResponse1Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfProductImageResponse1Data" /> class.
        /// </summary>
        ...
        public AllOfProductImageResponse1Data(DateTime? dateModified = default(DateTime?), int? id = default(int?), int? productId = default(int?), string urlStandard = default(string), string urlThumbnail = default(string), string urlTiny = default(string), string urlZoom = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfProductImageResponse1Data {\n");
        ...
        {
            return this.Equals(input as AllOfProductImageResponse1Data);
        }

        /// <summary>
        /// Returns true if AllOfProductImageResponse1Data instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfProductImageResponse1Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfProductImageResponse1Data input)
        {
            if (input == null)
                return false;
