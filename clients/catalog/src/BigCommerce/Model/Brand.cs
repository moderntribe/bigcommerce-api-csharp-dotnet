...
namespace BigCommerce.Model
{
        ...
        public partial class Brand :  IEquatable<Brand>, IValidatableObject
    {
        ...
        public Brand(CustomUrlBrand customUrl = default(CustomUrlBrand), int? id = default(int?), string imageUrl = default(string), string metaDescription = default(string), List<string> metaKeywords = default(List<string>), string name = default(string), string pageTitle = default(string), string searchKeywords = default(string))
        {
