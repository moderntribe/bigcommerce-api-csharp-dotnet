...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AdjusterFull :  IEquatable<AdjusterFull>, IValidatableObject
    {
        /// <summary>
        ...
        public AdjusterEnum? Adjuster { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="AdjusterFull" /> class.
        /// </summary>
        ...
        public AdjusterFull(AdjusterEnum? adjuster = default(AdjusterEnum?), decimal? adjusterValue = default(decimal?))
        {
        ...
        {
            return this.Equals(input as AdjusterFull);
        }

        /// <summary>
        /// Returns true if AdjusterFull instances are equal
        /// </summary>
        /// <param name="input">Instance of AdjusterFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdjusterFull input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.Adjuster == input.Adjuster ||
                    (this.Adjuster != null &&
                    this.Adjuster.Equals(input.Adjuster))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Adjuster != null)
                    hashCode = hashCode * 59 + this.Adjuster.GetHashCode();
