...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductVideoFull :  IEquatable<ProductVideoFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVideoFull" /> class.
        /// </summary>
        ...
        public ProductVideoFull(int? id = default(int?), string length = default(string), int? productId = default(int?))
        {
            this.Id = id;
            this.Length = length;
        ...
        {
            return this.Equals(input as ProductVideoFull);
        }

        /// <summary>
        /// Returns true if ProductVideoFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVideoFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVideoFull input)
        {
            if (input == null)
                return false;
