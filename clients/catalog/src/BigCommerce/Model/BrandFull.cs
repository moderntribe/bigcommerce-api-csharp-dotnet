...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BrandFull :  IEquatable<BrandFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BrandFull" /> class.
        /// </summary>
        ...
        public BrandFull(CustomUrlCategory customUrl = default(CustomUrlCategory), int? id = default(int?), string imageUrl = default(string), string metaDescription = default(string), List<string> metaKeywords = default(List<string>), string name = default(string), string pageTitle = default(string), string searchKeywords = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for BrandFull and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as BrandFull);
        }

        /// <summary>
        /// Returns true if BrandFull instances are equal
        /// </summary>
        /// <param name="input">Instance of BrandFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BrandFull input)
        {
            if (input == null)
                return false;
