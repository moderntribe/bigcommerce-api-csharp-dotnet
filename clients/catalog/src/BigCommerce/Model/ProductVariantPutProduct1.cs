...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductVariantPutProduct1 :  IEquatable<ProductVariantPutProduct1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductVariantPutProduct1" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProductVariantPutProduct1 {\n");
        ...
        {
            return this.Equals(input as ProductVariantPutProduct1);
        }

        /// <summary>
        /// Returns true if ProductVariantPutProduct1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductVariantPutProduct1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductVariantPutProduct1 input)
        {
            if (input == null)
                return false;
