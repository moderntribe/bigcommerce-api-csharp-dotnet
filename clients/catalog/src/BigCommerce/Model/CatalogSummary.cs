...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CatalogSummary :  IEquatable<CatalogSummary>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatalogSummary" /> class.
        /// </summary>
        ...
        public CatalogSummary(double? averageVariantPrice = default(double?), double? highestVariantPrice = default(double?), int? inventoryCount = default(int?), double? inventoryValue = default(double?), string lowestVariantPrice = default(string), string newestVariantDate = default(string), string oldestVariantDate = default(string), int? primaryCategoryId = default(int?), string primaryCategoryName = default(string), int? variantCount = default(int?))
        {
        ...
        {
            return this.Equals(input as CatalogSummary);
        }

        /// <summary>
        /// Returns true if CatalogSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of CatalogSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CatalogSummary input)
        {
            if (input == null)
                return false;
