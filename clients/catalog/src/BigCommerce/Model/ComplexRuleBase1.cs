...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ComplexRuleBase1 :  IEquatable<ComplexRuleBase1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplexRuleBase1" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ComplexRuleBase1 {\n");
        ...
        {
            return this.Equals(input as ComplexRuleBase1);
        }

        /// <summary>
        /// Returns true if ComplexRuleBase1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplexRuleBase1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplexRuleBase1 input)
        {
            if (input == null)
                return false;
