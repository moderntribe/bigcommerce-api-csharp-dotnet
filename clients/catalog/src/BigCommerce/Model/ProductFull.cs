...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductFull :  IEquatable<ProductFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductFull" /> class.
        /// </summary>
        ...
        public ProductFull(int? baseVariantId = default(int?), float? calculatedPrice = default(float?), DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?), int? id = default(int?), decimal? mapPrice = default(decimal?), List<Object> modifiers = default(List<Object>), string optionSetDisplay = default(string), int? optionSetId = default(int?), List<ProductOptionBase1> options = default(List<ProductOptionBase1>), Object variants = default(Object))
        {
        ...
        {
            return this.Equals(input as ProductFull);
        }

        /// <summary>
        /// Returns true if ProductFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductFull input)
        {
            if (input == null)
                return false;
