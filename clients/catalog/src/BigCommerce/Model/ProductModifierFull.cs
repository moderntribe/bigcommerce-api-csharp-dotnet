...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProductModifierFull :  IEquatable<ProductModifierFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductModifierFull" /> class.
        /// </summary>
        ...
        public ProductModifierFull(int? id = default(int?), string name = default(string), List<Object> optionValues = default(List<Object>), int? productId = default(int?))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as ProductModifierFull);
        }

        /// <summary>
        /// Returns true if ProductModifierFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductModifierFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductModifierFull input)
        {
            if (input == null)
                return false;
