...
namespace BigCommerce.Model
{
        ...
        public partial class ErrorNotFound :  IEquatable<ErrorNotFound>, IValidatableObject
    {
        ...
        /// <param name="status">404 HTTP status code. .</param>
        /// <param name="title">The error title describing the particular error..</param>
        /// <param name="type">type.</param>
        public ErrorNotFound(string instance = default(string), int? status = default(int?), string title = default(string), string type = default(string))
        {
        ...
        {
            return this.Equals(input as ErrorNotFound);
        }

        /// <summary>
        /// Returns true if ErrorNotFound instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorNotFound to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorNotFound input)
        {
            if (input == null)
                return false;
