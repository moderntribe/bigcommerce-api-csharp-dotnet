...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CategoriesTreeNodeFull1 :  IEquatable<CategoriesTreeNodeFull1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CategoriesTreeNodeFull1" /> class.
        /// </summary>
        ...
        public CategoriesTreeNodeFull1(List<Object> children = default(List<Object>), int? id = default(int?), bool? isVisible = default(bool?), string name = default(string), int? parentId = default(int?), string url = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CategoriesTreeNodeFull1 {\n");
        ...
        {
            return this.Equals(input as CategoriesTreeNodeFull1);
        }

        /// <summary>
        /// Returns true if CategoriesTreeNodeFull1 instances are equal
        /// </summary>
        /// <param name="input">Instance of CategoriesTreeNodeFull1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategoriesTreeNodeFull1 input)
        {
            if (input == null)
                return false;
