...
namespace BigCommerce.Model
{
        ...
        public partial class ProductBase :  IEquatable<ProductBase>, IValidatableObject
    {
        ...
        public ProductBase(AvailabilityEnum? availability = default(AvailabilityEnum?), string availabilityDescription = default(string), string binPickingNumber = default(string), int? brandId = default(int?), string brandNameOrBrandId = default(string), List<BulkPricingRuleFull1> bulkPricingRules = default(List<BulkPricingRuleFull1>), List<int?> categories = default(List<int?>), ConditionEnum? condition = default(ConditionEnum?), float? costPrice = default(float?), List<AllOfproductBaseCustomFieldsItems> customFields = default(List<AllOfproductBaseCustomFieldsItems>), CustomUrlCategory customUrl = default(CustomUrlCategory), float? depth = default(float?), string description = default(string), float? fixedCostShippingPrice = default(float?), List<int?> giftWrappingOptionsList = default(List<int?>), GiftWrappingOptionsTypeEnum? giftWrappingOptionsType = default(GiftWrappingOptionsTypeEnum?), string gtin = default(string), float? height = default(float?), List<AllOfproductBaseImagesItems> images = default(List<AllOfproductBaseImagesItems>), int? inventoryLevel = default(int?), InventoryTrackingEnum? inventoryTracking = default(InventoryTrackingEnum?), int? inventoryWarningLevel = default(int?), bool? isConditionShown = default(bool?), bool? isFeatured = default(bool?), bool? isFreeShipping = default(bool?), bool? isPreorderOnly = default(bool?), bool? isPriceHidden = default(bool?), bool? isVisible = default(bool?), string layoutFile = default(string), string metaDescription = default(string), List<string> metaKeywords = default(List<string>), string mpn = default(string), string name = default(string), string openGraphDescription = default(string), string openGraphTitle = default(string), OpenGraphTypeEnum? openGraphType = default(OpenGraphTypeEnum?), bool? openGraphUseImage = default(bool?), bool? openGraphUseMetaDescription = default(bool?), bool? openGraphUseProductName = default(bool?), int? orderQuantityMaximum = default(int?), int? orderQuantityMinimum = default(int?), string pageTitle = default(string), string preorderMessage = default(string), DateTime? preorderReleaseDate = default(DateTime?), float? price = default(float?), string priceHiddenLabel = default(string), string productTaxCode = default(string), List<int?> relatedProducts = default(List<int?>), float? retailPrice = default(float?), int? reviewsCount = default(int?), int? reviewsRatingSum = default(int?), float? salePrice = default(float?), string searchKeywords = default(string), string sku = default(string), int? sortOrder = default(int?), int? taxClassId = default(int?), int? totalSold = default(int?), TypeEnum type = default(TypeEnum), string upc = default(string), List<AllOfproductBaseVideosItems> videos = default(List<AllOfproductBaseVideosItems>), int? viewCount = default(int?), string warranty = default(string), float? weight = default(float?), float? width = default(float?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ProductBase and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (price == null)
            {
                throw new InvalidDataException("price is a required property for ProductBase and cannot be null");
            }
            else
            {
                this.Price = price;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ProductBase and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (weight == null)
            {
                throw new InvalidDataException("weight is a required property for ProductBase and cannot be null");
            }
            else
            {
                this.Weight = weight;
        ...
        public List<AllOfproductBaseCustomFieldsItems> CustomFields { get; set; }
        ...
        public List<AllOfproductBaseImagesItems> Images { get; set; }
        ...
        public List<AllOfproductBaseVideosItems> Videos { get; set; }
