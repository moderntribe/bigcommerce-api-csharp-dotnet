...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetafieldBase1 :  IEquatable<MetafieldBase1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetafieldBase1" /> class.
        /// </summary>
        ...
        public MetafieldBase1(DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?), string description = default(string), int? id = default(int?), string key = default(string), string _namespace = default(string), PermissionSetEnum permissionSet = default(PermissionSetEnum), int? resourceId = default(int?), ResourceTypeEnum? resourceType = default(ResourceTypeEnum?), string value = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MetafieldBase1 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("permissionSet is a required property for MetafieldBase1 and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for MetafieldBase1 and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MetafieldBase1 {\n");
        ...
        {
            return this.Equals(input as MetafieldBase1);
        }

        /// <summary>
        /// Returns true if MetafieldBase1 instances are equal
        /// </summary>
        /// <param name="input">Instance of MetafieldBase1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetafieldBase1 input)
        {
            if (input == null)
                return false;
