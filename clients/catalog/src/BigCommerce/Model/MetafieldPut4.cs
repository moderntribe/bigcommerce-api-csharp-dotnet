...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetafieldPut4 :  IEquatable<MetafieldPut4>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MetafieldPut4" /> class.
        /// </summary>
        ...
        public MetafieldPut4(DateTime? dateCreated = default(DateTime?), DateTime? dateModified = default(DateTime?), string description = default(string), int? id = default(int?), string key = default(string), string _namespace = default(string), PermissionSetEnum permissionSet = default(PermissionSetEnum), int? resourceId = default(int?), ResourceTypeEnum? resourceType = default(ResourceTypeEnum?), string value = default(string))
        {
            ...
            if (_namespace == null)
            {
                throw new InvalidDataException("_namespace is a required property for MetafieldPut4 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("permissionSet is a required property for MetafieldPut4 and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for MetafieldPut4 and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as MetafieldPut4);
        }

        /// <summary>
        /// Returns true if MetafieldPut4 instances are equal
        /// </summary>
        /// <param name="input">Instance of MetafieldPut4 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetafieldPut4 input)
        {
            if (input == null)
                return false;
