...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfProductImageResponseData :  IEquatable<AllOfProductImageResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfProductImageResponseData" /> class.
        /// </summary>
        ...
        public AllOfProductImageResponseData(DateTime? dateModified = default(DateTime?), int? id = default(int?), string imageFile = default(string), string imageUrl = default(string), int? productId = default(int?), string urlStandard = default(string), string urlThumbnail = default(string), string urlTiny = default(string), string urlZoom = default(string))
        {
        ...
        /// </summary>
        /// <value>The local path to the original image file uploaded to BigCommerce. Use image_url when creating a product. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfProductImageResponseData {\n");
        ...
        {
            return this.Equals(input as AllOfProductImageResponseData);
        }

        /// <summary>
        /// Returns true if AllOfProductImageResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfProductImageResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfProductImageResponseData input)
        {
            if (input == null)
                return false;
