...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CustomUrlCategory :  IEquatable<CustomUrlCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomUrlCategory" /> class.
        /// </summary>
        ...
        /// <param name="url">Category URL on the storefront. .</param>
        public CustomUrlCategory(bool? isCustomized = default(bool?), string url = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomUrlCategory {\n");
        ...
        {
            return this.Equals(input as CustomUrlCategory);
        }

        /// <summary>
        /// Returns true if CustomUrlCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomUrlCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomUrlCategory input)
        {
            if (input == null)
                return false;
