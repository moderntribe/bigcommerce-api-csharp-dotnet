...
namespace BigCommerce.Model
{
        ...
        public partial class InlineResponse2001 :  IEquatable<InlineResponse2001>, IValidatableObject
    {
        ...
        public InlineResponse2001(List<AllOfinlineResponse2001DataItems> data = default(List<AllOfinlineResponse2001DataItems>), MetaCollectionFull1 meta = default(MetaCollectionFull1))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<AllOfinlineResponse2001DataItems> Data { get; set; }
