...
namespace BigCommerce.Model
{
        ...
        public partial class Category :  IEquatable<Category>, IValidatableObject
    {
        ...
        public Category(CustomUrlCategory customUrl = default(CustomUrlCategory), DefaultProductSortEnum? defaultProductSort = default(DefaultProductSortEnum?), string description = default(string), int? id = default(int?), string imageUrl = default(string), bool? isVisible = default(bool?), string layoutFile = default(string), string metaDescription = default(string), List<string> metaKeywords = default(List<string>), string name = default(string), string pageTitle = default(string), int? parentId = default(int?), string searchKeywords = default(string), int? sortOrder = default(int?), int? views = default(int?))
        {
            ...
            if (parentId == null)
            {
                throw new InvalidDataException("parentId is a required property for Category and cannot be null");
            }
            else
            {
