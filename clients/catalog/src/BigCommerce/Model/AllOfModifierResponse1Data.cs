...
namespace BigCommerce.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfModifierResponse1Data :  IEquatable<AllOfModifierResponse1Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfModifierResponse1Data" /> class.
        /// </summary>
        ...
        public AllOfModifierResponse1Data(int? id = default(int?), string name = default(string), List<Object> optionValues = default(List<Object>), int? productId = default(int?))
        {
            this.Id = id;
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfModifierResponse1Data {\n");
        ...
        {
            return this.Equals(input as AllOfModifierResponse1Data);
        }

        /// <summary>
        /// Returns true if AllOfModifierResponse1Data instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfModifierResponse1Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfModifierResponse1Data input)
        {
            if (input == null)
                return false;
