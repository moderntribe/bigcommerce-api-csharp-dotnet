# BigCommerce.Model.AllOfModifierCollectionResponseDataItems
## Properties
...
**OptionValues** | **List&lt;Object&gt;** |  | [optional] 
**ProductId** | **int?** | The unique numeric ID of the product to which the option belongs.  | [optional] 
