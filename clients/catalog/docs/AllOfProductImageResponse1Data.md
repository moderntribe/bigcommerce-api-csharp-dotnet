# BigCommerce.Model.AllOfProductImageResponse1Data
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**DateModified** | **DateTime?** | The date on which the product image was modified.  | [optional] 
**Id** | **int?** | The unique numeric ID of the image; increments sequentially.  | [optional] 
**ProductId** | **int?** | The unique numeric identifier for the product with which the image is associated.  | [optional] 
