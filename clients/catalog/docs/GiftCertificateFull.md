...
**OriginalBalance** | **float?** | The balance on a gift certificate when it was purchased.  | [optional] 
**RemainingBalance** | **float?** | The remaining balance on a gift certificate.  | [optional] 
**StartingBalance** | **float?** | The balance on a gift certificate at the time of this purchase.  | [optional] 
