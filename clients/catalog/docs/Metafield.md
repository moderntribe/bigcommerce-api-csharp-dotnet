# Catalog.Model.Metafield
## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**CreatedAt** | **DateTime?** | Date and time of the metafield&#x27;s creation. Read-Only.  | [optional] 
...
**UpdatedAt** | **DateTime?** | Date and time when the metafield was last updated. Read-Only.  | [optional] 
