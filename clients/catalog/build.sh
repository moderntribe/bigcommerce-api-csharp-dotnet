...
${nuget_cmd} install src/Catalog/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Catalog.dll"
...
then
  ...
  echo "[INFO] bin/Catalog.dll was created successfully"
fi
