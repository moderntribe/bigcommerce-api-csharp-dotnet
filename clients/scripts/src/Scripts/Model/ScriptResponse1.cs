...
namespace Scripts.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScriptResponse1 :  IEquatable<ScriptResponse1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScriptResponse1" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="meta">Empty meta object; may be used later..</param>
        public ScriptResponse1(AllOfscriptResponse1Data data = default(AllOfscriptResponse1Data), Object meta = default(Object))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public AllOfscriptResponse1Data Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScriptResponse1 {\n");
        ...
        {
            return this.Equals(input as ScriptResponse1);
        }

        /// <summary>
        /// Returns true if ScriptResponse1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ScriptResponse1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScriptResponse1 input)
        {
            if (input == null)
                return false;
