...
namespace Scripts.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScriptsResponse :  IEquatable<ScriptsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ScriptsResponse(List<AllOfScriptsResponseDataItems> data = default(List<AllOfScriptsResponseDataItems>), CollectionMeta meta = default(CollectionMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<AllOfScriptsResponseDataItems> Data { get; set; }
        ...
        {
            return this.Equals(input as ScriptsResponse);
        }

        /// <summary>
        /// Returns true if ScriptsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ScriptsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScriptsResponse input)
        {
            if (input == null)
                return false;
