# BigCommerce.Model.AllOfscriptResponseCollectionDataItems
## Properties
...
**AutoUninstall** | **bool?** | It will enable automatic cleanup of the script when the single click app is uninstalled or OAuth token is revoked. | [optional] 
