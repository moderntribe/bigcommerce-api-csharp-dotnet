...
${nuget_cmd} install src/Scripts/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Scripts.dll"
...
then
  ...
  echo "[INFO] bin/Scripts.dll was created successfully"
fi
