...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfinlineResponse2004Data :  IEquatable<AllOfinlineResponse2004Data>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfinlineResponse2004Data" /> class.
        /// </summary>
        ...
        public AllOfinlineResponse2004Data(string entityId = default(string), int? sortOrder = default(int?), string region = default(string), StatusEnum? status = StatusEnum.Inactive, Object widget = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfinlineResponse2004Data {\n");
        ...
        {
            return this.Equals(input as AllOfinlineResponse2004Data);
        }

        /// <summary>
        /// Returns true if AllOfinlineResponse2004Data instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfinlineResponse2004Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfinlineResponse2004Data input)
        {
            if (input == null)
                return false;
