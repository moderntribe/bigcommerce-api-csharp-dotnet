...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlacementPost1 :  IEquatable<PlacementPost1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlacementPost1" /> class.
        /// </summary>
        ...
        public PlacementPost1(string entityId = default(string), int? sortOrder = default(int?), string region = default(string), StatusEnum? status = StatusEnum.Inactive)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlacementPost1 {\n");
        ...
        {
            return this.Equals(input as PlacementPost1);
        }

        /// <summary>
        /// Returns true if PlacementPost1 instances are equal
        /// </summary>
        /// <param name="input">Instance of PlacementPost1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlacementPost1 input)
        {
            if (input == null)
                return false;
