...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WidgetSchemaSettingBase :  IEquatable<WidgetSchemaSettingBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WidgetSchemaSettingBase" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WidgetSchemaSettingBase {\n");
        ...
        {
            return this.Equals(input as WidgetSchemaSettingBase);
        }

        /// <summary>
        /// Returns true if WidgetSchemaSettingBase instances are equal
        /// </summary>
        /// <param name="input">Instance of WidgetSchemaSettingBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WidgetSchemaSettingBase input)
        {
            if (input == null)
                return false;
