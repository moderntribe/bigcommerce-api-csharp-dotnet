...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlacementFull :  IEquatable<PlacementFull>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlacementFull" /> class.
        /// </summary>
        ...
        public PlacementFull(string entityId = default(string), int? sortOrder = default(int?), string region = default(string), StatusEnum? status = StatusEnum.Inactive, Object widget = default(Object))
        {
        ...
        {
            return this.Equals(input as PlacementFull);
        }

        /// <summary>
        /// Returns true if PlacementFull instances are equal
        /// </summary>
        /// <param name="input">Instance of PlacementFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlacementFull input)
        {
            if (input == null)
                return false;
