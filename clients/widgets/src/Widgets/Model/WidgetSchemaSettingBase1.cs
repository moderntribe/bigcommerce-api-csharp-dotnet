...
namespace Widgets.Model
{
        ...
        public partial class WidgetSchemaSettingBase1 :  IEquatable<WidgetSchemaSettingBase1>, IValidatableObject
    {
        ...
        public WidgetSchemaSettingBase1(TypeEnum? type = default(TypeEnum?), string label = default(string), string id = default(string), string _default = default(string), string typeMeta = default(string), string conditional = default(string))
        {
            this.Type = type;
            this.Label = label;
            this.Id = id;
