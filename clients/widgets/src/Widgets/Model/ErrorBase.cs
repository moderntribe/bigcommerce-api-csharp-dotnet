...
namespace Widgets.Model
{
        ...
        public partial class ErrorBase :  IEquatable<ErrorBase>, IValidatableObject
    {
        ...
        public ErrorBase(int? status = default(int?), string title = default(string), string type = default(string), string instance = default(string), Object errors = default(Object))
        {
            this.Status = status;
            this.Title = title;
            this.Type = type;
