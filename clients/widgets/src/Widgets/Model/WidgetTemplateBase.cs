...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WidgetTemplateBase :  IEquatable<WidgetTemplateBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WidgetTemplateBase" /> class.
        /// </summary>
        ...
        public WidgetTemplateBase(string name = default(string), List<Object> schema = default(List<Object>), string template = default(string))
        {
            this.Name = name;
            this.Schema = schema;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WidgetTemplateBase {\n");
        ...
        {
            return this.Equals(input as WidgetTemplateBase);
        }

        /// <summary>
        /// Returns true if WidgetTemplateBase instances are equal
        /// </summary>
        /// <param name="input">Instance of WidgetTemplateBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WidgetTemplateBase input)
        {
            if (input == null)
                return false;
