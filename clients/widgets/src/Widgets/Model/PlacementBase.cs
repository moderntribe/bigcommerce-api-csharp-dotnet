...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlacementBase :  IEquatable<PlacementBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlacementBase" /> class.
        /// </summary>
        ...
        public PlacementBase(string entityId = default(string), int? sortOrder = default(int?), string region = default(string), StatusEnum? status = StatusEnum.Inactive)
        {
        ...
        {
            return this.Equals(input as PlacementBase);
        }

        /// <summary>
        /// Returns true if PlacementBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PlacementBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlacementBase input)
        {
            if (input == null)
                return false;
