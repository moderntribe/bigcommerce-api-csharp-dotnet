...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfinlineResponse2003DataItems :  IEquatable<AllOfinlineResponse2003DataItems>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfinlineResponse2003DataItems" /> class.
        /// </summary>
        ...
        public AllOfinlineResponse2003DataItems(string entityId = default(string), int? sortOrder = default(int?), string region = default(string), StatusEnum? status = StatusEnum.Inactive, Object widget = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfinlineResponse2003DataItems {\n");
        ...
        {
            return this.Equals(input as AllOfinlineResponse2003DataItems);
        }

        /// <summary>
        /// Returns true if AllOfinlineResponse2003DataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfinlineResponse2003DataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfinlineResponse2003DataItems input)
        {
            if (input == null)
                return false;
