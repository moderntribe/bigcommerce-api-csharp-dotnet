...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlacementPut :  IEquatable<PlacementPut>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PlacementPut" /> class.
        /// </summary>
        ...
        public PlacementPut(string entityId = default(string), int? sortOrder = default(int?), string region = default(string), StatusEnum? status = StatusEnum.Inactive)
        {
        ...
        {
            return this.Equals(input as PlacementPut);
        }

        /// <summary>
        /// Returns true if PlacementPut instances are equal
        /// </summary>
        /// <param name="input">Instance of PlacementPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlacementPut input)
        {
            if (input == null)
                return false;
