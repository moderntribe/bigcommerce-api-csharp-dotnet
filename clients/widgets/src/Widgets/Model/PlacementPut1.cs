...
namespace Widgets.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PlacementPut1 :  IEquatable<PlacementPut1>, IValidatableObject
    {
        /// <summary>
        ...
        public PlacementPut1(string entityId = default(string), int? sortOrder = default(int?), string region = default(string), StatusEnum? status = StatusEnum.Inactive)
        {
        ...
        {
            return this.Equals(input as PlacementPut1);
        }

        /// <summary>
        /// Returns true if PlacementPut1 instances are equal
        /// </summary>
        /// <param name="input">Instance of PlacementPut1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlacementPut1 input)
        {
            if (input == null)
                return false;
