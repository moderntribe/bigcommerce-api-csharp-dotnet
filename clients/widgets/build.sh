...
${nuget_cmd} install src/Widgets/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Widgets.dll"
...
then
  ...
  echo "[INFO] bin/Widgets.dll was created successfully"
fi
