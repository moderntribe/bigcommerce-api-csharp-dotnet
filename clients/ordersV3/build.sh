...
${nuget_cmd} install src/OrdersV3/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/OrdersV3.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/OrdersV3.dll \
-recurse:'src/OrdersV3/*.cs' \
-doc:bin/OrdersV3.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/OrdersV3.dll was created successfully"
fi
