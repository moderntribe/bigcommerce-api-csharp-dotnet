...
${nuget_cmd} install src/BigCommerce/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/BigCommerce.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/BigCommerce.dll \
-recurse:'src/BigCommerce/*.cs' \
-doc:bin/BigCommerce.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/BigCommerce.dll was created successfully"
fi
