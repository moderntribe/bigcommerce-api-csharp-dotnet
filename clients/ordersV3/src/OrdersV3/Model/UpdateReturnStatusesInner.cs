...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateReturnStatusesInner :  IEquatable<UpdateReturnStatusesInner>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateReturnStatusesInner" /> class.
        /// </summary>
        /// <param name="id">The ID of the return for which the status was updated.</param>
        /// <param name="status">The status of the return..</param>
        public UpdateReturnStatusesInner(long? id = default(long?), StatusEnum? status = default(StatusEnum?))
        {
            this.Id = id;
            this.Status = status;
        }
        ...
        /// </summary>
        /// <value>The ID of the return for which the status was updated</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateReturnStatusesInner {\n");
        ...
        {
            return this.Equals(input as UpdateReturnStatusesInner);
        }

        /// <summary>
        /// Returns true if UpdateReturnStatusesInner instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateReturnStatusesInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateReturnStatusesInner input)
        {
            if (input == null)
                return false;
