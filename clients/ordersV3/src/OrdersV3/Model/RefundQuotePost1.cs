...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefundQuotePost1 :  IEquatable<RefundQuotePost1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundQuotePost1" /> class.
        /// </summary>
        /// <param name="orderId">Order ID against which this refund will be created. This is optional for creating a single refund request. The order ID is included in the request path. (required).</param>
        /// <param name="items">items (required).</param>
        public RefundQuotePost1(int? orderId = default(int?), List<Object> items = default(List<Object>))
        {
            // to ensure "orderId" is required (not null)
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for RefundQuotePost1 and cannot be null");
            }
            else
            {
            ...
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for RefundQuotePost1 and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundQuotePost1 {\n");
        ...
        {
            return this.Equals(input as RefundQuotePost1);
        }

        /// <summary>
        /// Returns true if RefundQuotePost1 instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundQuotePost1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundQuotePost1 input)
        {
            if (input == null)
                return false;
