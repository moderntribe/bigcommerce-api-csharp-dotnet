...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReceivedItemsBaseInner :  IEquatable<ReceivedItemsBaseInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivedItemsBaseInner" /> class.
        /// </summary>
        /// <param name="itemId">The ID of the item for which received item status was updated.</param>
        /// <param name="receivedQuantity">The quantity of items marked as received.</param>
        /// <param name="pendingQuantity">The quantity of items marked as pending.</param>
        public ReceivedItemsBaseInner(long? itemId = default(long?), long? receivedQuantity = default(long?), long? pendingQuantity = default(long?))
        {
            this.ItemId = itemId;
        ...
        /// </summary>
        /// <value>The ID of the item for which received item status was updated</value>
        ...
        /// </summary>
        /// <value>The quantity of items marked as received</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReceivedItemsBaseInner {\n");
        ...
        {
            return this.Equals(input as ReceivedItemsBaseInner);
        }

        /// <summary>
        /// Returns true if ReceivedItemsBaseInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ReceivedItemsBaseInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReceivedItemsBaseInner input)
        {
            if (input == null)
                return false;
