...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReviewedItemsBaseInner :  IEquatable<ReviewedItemsBaseInner>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewedItemsBaseInner" /> class.
        /// </summary>
        /// <param name="itemId">The ID of the item for which reviewed status was updated.</param>
        /// <param name="authorizedQuantity">The quantity of items marked as authorized.</param>
        /// <param name="rejectedQuantity">The quantity of items marked as rejected.</param>
        /// <param name="pendingQuantity">The quantity of items marked as pending.</param>
        public ReviewedItemsBaseInner(long? itemId = default(long?), long? authorizedQuantity = default(long?), long? rejectedQuantity = default(long?), long? pendingQuantity = default(long?))
        {
            this.ItemId = itemId;
        ...
        /// </summary>
        /// <value>The ID of the item for which reviewed status was updated</value>
        ...
        /// </summary>
        /// <value>The quantity of items marked as authorized</value>
        [DataMember(Name="authorized_quantity", EmitDefaultValue=false)]
        public long? AuthorizedQuantity { get; set; }

        /// <summary>
        /// The quantity of items marked as rejected
        /// </summary>
        /// <value>The quantity of items marked as rejected</value>
        ...
        /// </summary>
        /// <value>The quantity of items marked as pending</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewedItemsBaseInner {\n");
        ...
        {
            return this.Equals(input as ReviewedItemsBaseInner);
        }

        /// <summary>
        /// Returns true if ReviewedItemsBaseInner instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewedItemsBaseInner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewedItemsBaseInner input)
        {
            if (input == null)
                return false;
