...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfinlineResponse2003Data :  IEquatable<AllOfinlineResponse2003Data>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfinlineResponse2003Data" /> class.
        /// </summary>
        ...
        public AllOfinlineResponse2003Data(int? id = default(int?), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfinlineResponse2003Data {\n");
        ...
        {
            return this.Equals(input as AllOfinlineResponse2003Data);
        }

        /// <summary>
        /// Returns true if AllOfinlineResponse2003Data instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfinlineResponse2003Data to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfinlineResponse2003Data input)
        {
            if (input == null)
                return false;
