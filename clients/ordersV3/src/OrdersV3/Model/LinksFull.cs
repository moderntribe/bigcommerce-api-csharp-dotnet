...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LinksFull :  IEquatable<LinksFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LinksFull" /> class.
        /// </summary>
        ...
        public LinksFull(string previous = default(string), string current = default(string), string next = default(string))
        {
        ...
        {
            return this.Equals(input as LinksFull);
        }

        /// <summary>
        /// Returns true if LinksFull instances are equal
        /// </summary>
        /// <param name="input">Instance of LinksFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinksFull input)
        {
            if (input == null)
                return false;
