...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostRefundQuotesRequest : List<RefundQuotePost1>,  IEquatable<PostRefundQuotesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRefundQuotesRequest" /> class.
        /// </summary>
        public PostRefundQuotesRequest() : base()
        {
        }
        ...
        {
            return this.Equals(input as PostRefundQuotesRequest);
        }

        /// <summary>
        /// Returns true if PostRefundQuotesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostRefundQuotesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostRefundQuotesRequest input)
        {
            if (input == null)
                return false;
