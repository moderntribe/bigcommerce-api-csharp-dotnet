...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Offline :  IEquatable<Offline>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Offline" /> class.
        /// </summary>
        /// <param name="displayName">Display name for the offline payment. .</param>
        public Offline(string displayName = default(string))
        {
        ...
        {
            return this.Equals(input as Offline);
        }

        /// <summary>
        /// Returns true if Offline instances are equal
        /// </summary>
        /// <param name="input">Instance of Offline to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Offline input)
        {
            if (input == null)
                return false;
