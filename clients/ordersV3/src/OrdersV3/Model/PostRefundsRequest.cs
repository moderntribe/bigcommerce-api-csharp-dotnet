...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PostRefundsRequest : List<RefundRequestPost2>,  IEquatable<PostRefundsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostRefundsRequest" /> class.
        /// </summary>
        public PostRefundsRequest() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostRefundsRequest {\n");
        ...
        {
            return this.Equals(input as PostRefundsRequest);
        }

        /// <summary>
        /// Returns true if PostRefundsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PostRefundsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PostRefundsRequest input)
        {
            if (input == null)
                return false;
