...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReviewedItemsBase : List<ReviewedItemsBaseInner>,  IEquatable<ReviewedItemsBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewedItemsBase" /> class.
        /// </summary>
        public ReviewedItemsBase() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewedItemsBase {\n");
        ...
        {
            return this.Equals(input as ReviewedItemsBase);
        }

        /// <summary>
        /// Returns true if ReviewedItemsBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewedItemsBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewedItemsBase input)
        {
            if (input == null)
                return false;
