...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefundRequestPost1 :  IEquatable<RefundRequestPost1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundRequestPost1" /> class.
        /// </summary>
        ...
        public RefundRequestPost1(int? orderId = default(int?), List<Object> items = default(List<Object>), string reason = default(string), List<PaymentRequest> payments = default(List<PaymentRequest>))
        {
            // to ensure "orderId" is required (not null)
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for RefundRequestPost1 and cannot be null");
            }
            else
            {
            ...
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for RefundRequestPost1 and cannot be null");
            }
            else
            {
                this.Items = items;
            ...
            if (payments == null)
            {
                throw new InvalidDataException("payments is a required property for RefundRequestPost1 and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundRequestPost1 {\n");
        ...
        {
            return this.Equals(input as RefundRequestPost1);
        }

        /// <summary>
        /// Returns true if RefundRequestPost1 instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundRequestPost1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundRequestPost1 input)
        {
            if (input == null)
                return false;
