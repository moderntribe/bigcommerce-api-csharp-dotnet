...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PreferredOutcome :  IEquatable<PreferredOutcome>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreferredOutcome" /> class.
        /// </summary>
        ...
        public PreferredOutcome(long? id = default(long?), string label = default(string), bool? isArchived = default(bool?))
        {
            this.Id = id;
            this.Label = label;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PreferredOutcome {\n");
        ...
        {
            return this.Equals(input as PreferredOutcome);
        }

        /// <summary>
        /// Returns true if PreferredOutcome instances are equal
        /// </summary>
        /// <param name="input">Instance of PreferredOutcome to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreferredOutcome input)
        {
            if (input == null)
                return false;
