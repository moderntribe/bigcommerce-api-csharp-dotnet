...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReviewedItemsPut : List<ReviewedItemsPutInner>,  IEquatable<ReviewedItemsPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewedItemsPut" /> class.
        /// </summary>
        public ReviewedItemsPut() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewedItemsPut {\n");
        ...
        {
            return this.Equals(input as ReviewedItemsPut);
        }

        /// <summary>
        /// Returns true if ReviewedItemsPut instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewedItemsPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewedItemsPut input)
        {
            if (input == null)
                return false;
