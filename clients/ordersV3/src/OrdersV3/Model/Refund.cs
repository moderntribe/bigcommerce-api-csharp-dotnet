...
namespace OrdersV3.Model
{
        ...
        public partial class Refund :  IEquatable<Refund>, IValidatableObject
    {
        ...
        public Refund(int? orderId = default(int?), string reason = default(string), float? totalAmount = default(float?), decimal? totalTax = default(decimal?), List<RefundItem> items = default(List<RefundItem>), List<RefundPayment> payments = default(List<RefundPayment>))
        {
