...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GetReturnsSettings :  IEquatable<GetReturnsSettings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReturnsSettings" /> class.
        /// </summary>
        /// <param name="reasons">reasons.</param>
        /// <param name="preferredOutcomes">preferredOutcomes.</param>
        public GetReturnsSettings(List<GetReturnsSettingsReasons> reasons = default(List<GetReturnsSettingsReasons>), List<GetReturnsSettingsPreferredOutcomes> preferredOutcomes = default(List<GetReturnsSettingsPreferredOutcomes>))
        {
            this.Reasons = reasons;
            this.PreferredOutcomes = preferredOutcomes;
        }
        ...
        public List<GetReturnsSettingsReasons> Reasons { get; set; }

        /// <summary>
        /// Gets or Sets PreferredOutcomes
        /// </summary>
        [DataMember(Name="preferred_outcomes", EmitDefaultValue=false)]
        public List<GetReturnsSettingsPreferredOutcomes> PreferredOutcomes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetReturnsSettings {\n");
            sb.Append("  Reasons: ").Append(Reasons).Append("\n");
            sb.Append("  PreferredOutcomes: ").Append(PreferredOutcomes).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as GetReturnsSettings);
        }

        /// <summary>
        /// Returns true if GetReturnsSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of GetReturnsSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetReturnsSettings input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.PreferredOutcomes == input.PreferredOutcomes ||
                    this.PreferredOutcomes != null &&
                    input.PreferredOutcomes != null &&
                    this.PreferredOutcomes.SequenceEqual(input.PreferredOutcomes)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PreferredOutcomes != null)
                    hashCode = hashCode * 59 + this.PreferredOutcomes.GetHashCode();
                return hashCode;
            }
        }
