...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefundRequestPost2 :  IEquatable<RefundRequestPost2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundRequestPost2" /> class.
        /// </summary>
        ...
        public RefundRequestPost2(int? orderId = default(int?), List<Object> items = default(List<Object>), string reason = default(string), List<Object> payments = default(List<Object>))
        {
            // to ensure "orderId" is required (not null)
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for RefundRequestPost2 and cannot be null");
            }
            else
            {
            ...
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for RefundRequestPost2 and cannot be null");
            }
            else
            {
                this.Items = items;
            ...
            if (payments == null)
            {
                throw new InvalidDataException("payments is a required property for RefundRequestPost2 and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundRequestPost2 {\n");
        ...
        {
            return this.Equals(input as RefundRequestPost2);
        }

        /// <summary>
        /// Returns true if RefundRequestPost2 instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundRequestPost2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundRequestPost2 input)
        {
            if (input == null)
                return false;
