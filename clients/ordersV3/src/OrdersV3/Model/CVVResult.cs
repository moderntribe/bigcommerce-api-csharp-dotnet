...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CVVResult :  IEquatable<CVVResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CVVResult" /> class.
        /// </summary>
        /// <param name="code">CVV code..</param>
        /// <param name="message">CVV message..</param>
        public CVVResult(string code = default(string), string message = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as CVVResult);
        }

        /// <summary>
        /// Returns true if CVVResult instances are equal
        /// </summary>
        /// <param name="input">Instance of CVVResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CVVResult input)
        {
            if (input == null)
                return false;
