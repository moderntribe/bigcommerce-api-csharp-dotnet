...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GetReturnableItems : List<GetReturnableItemsInner>,  IEquatable<GetReturnableItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReturnableItems" /> class.
        /// </summary>
        public GetReturnableItems() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetReturnableItems {\n");
        ...
        {
            return this.Equals(input as GetReturnableItems);
        }

        /// <summary>
        /// Returns true if GetReturnableItems instances are equal
        /// </summary>
        /// <param name="input">Instance of GetReturnableItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetReturnableItems input)
        {
            if (input == null)
                return false;
