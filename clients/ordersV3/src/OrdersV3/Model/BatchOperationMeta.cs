...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BatchOperationMeta :  IEquatable<BatchOperationMeta>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchOperationMeta" /> class.
        /// </summary>
        /// <param name="total">The total number of operations in the batch.</param>
        /// <param name="success">The number of failed operations in the batch.</param>
        /// <param name="failed">The number of failed operations in the batch.</param>
        public BatchOperationMeta(int? total = default(int?), int? success = default(int?), int? failed = default(int?))
        {
            this.Total = total;
        ...
        /// </summary>
        /// <value>The total number of operations in the batch</value>
        ...
        /// </summary>
        /// <value>The number of failed operations in the batch</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BatchOperationMeta {\n");
        ...
        {
            return this.Equals(input as BatchOperationMeta);
        }

        /// <summary>
        /// Returns true if BatchOperationMeta instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchOperationMeta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchOperationMeta input)
        {
            if (input == null)
                return false;
