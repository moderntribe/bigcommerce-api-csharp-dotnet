...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TransactionStoreCredit :  IEquatable<TransactionStoreCredit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionStoreCredit" /> class.
        /// </summary>
        /// <param name="remainingBalance">Remaining balance of shopper&#x27;s store credit. .</param>
        public TransactionStoreCredit(string remainingBalance = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionStoreCredit {\n");
        ...
        {
            return this.Equals(input as TransactionStoreCredit);
        }

        /// <summary>
        /// Returns true if TransactionStoreCredit instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionStoreCredit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionStoreCredit input)
        {
            if (input == null)
                return false;
