...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Custom :  IEquatable<Custom>, IValidatableObject
    {
        /// <summary>
        ...
        public Custom(string paymentMethod = default(string))
        {
        ...
        {
            return this.Equals(input as Custom);
        }

        /// <summary>
        /// Returns true if Custom instances are equal
        /// </summary>
        /// <param name="input">Instance of Custom to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Custom input)
        {
            if (input == null)
                return false;
