...
namespace OrdersV3.Model
{
        ...
        public partial class MetafieldResponse :  IEquatable<MetafieldResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="data">Allows app partners to write custom data to various resources in the API. .</param>
        /// <param name="meta">meta.</param>
        public MetafieldResponse(AllOfMetafieldResponseData data = default(AllOfMetafieldResponseData), Meta1 meta = default(Meta1))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        /// </summary>
        /// <value>Allows app partners to write custom data to various resources in the API. </value>
        [DataMember(Name="data", EmitDefaultValue=false)]
        public AllOfMetafieldResponseData Data { get; set; }
