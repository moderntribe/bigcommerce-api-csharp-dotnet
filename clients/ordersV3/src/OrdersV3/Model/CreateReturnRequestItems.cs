...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturnRequestItems :  IEquatable<CreateReturnRequestItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturnRequestItems" /> class.
        /// </summary>
        ...
        public CreateReturnRequestItems(CreateReturnRequestReferenceId referenceId = default(CreateReturnRequestReferenceId), int? quantity = default(int?), long? preferredOutcomeId = default(long?), long? reasonId = default(long?))
        {
            // to ensure "referenceId" is required (not null)
            if (referenceId == null)
            {
                throw new InvalidDataException("referenceId is a required property for CreateReturnRequestItems and cannot be null");
            }
            else
            {
            ...
            if (quantity == null)
            {
                throw new InvalidDataException("quantity is a required property for CreateReturnRequestItems and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("preferredOutcomeId is a required property for CreateReturnRequestItems and cannot be null");
            }
            else
            {
            ...
            if (reasonId == null)
            {
                throw new InvalidDataException("reasonId is a required property for CreateReturnRequestItems and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateReturnRequestItems {\n");
        ...
        {
            return this.Equals(input as CreateReturnRequestItems);
        }

        /// <summary>
        /// Returns true if CreateReturnRequestItems instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturnRequestItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturnRequestItems input)
        {
            if (input == null)
                return false;
