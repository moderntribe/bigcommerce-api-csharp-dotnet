...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefundMethod : List<PaymentOption>,  IEquatable<RefundMethod>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundMethod" /> class.
        /// </summary>
        public RefundMethod() : base()
        {
        }
        ...
        {
            return this.Equals(input as RefundMethod);
        }

        /// <summary>
        /// Returns true if RefundMethod instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundMethod to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundMethod input)
        {
            if (input == null)
                return false;
