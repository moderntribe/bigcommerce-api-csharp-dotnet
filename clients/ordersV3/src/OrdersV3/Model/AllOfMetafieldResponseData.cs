...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfMetafieldResponseData :  IEquatable<AllOfMetafieldResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfMetafieldResponseData" /> class.
        /// </summary>
        ...
        public AllOfMetafieldResponseData(int? id = default(int?), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfMetafieldResponseData {\n");
        ...
        {
            return this.Equals(input as AllOfMetafieldResponseData);
        }

        /// <summary>
        /// Returns true if AllOfMetafieldResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfMetafieldResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfMetafieldResponseData input)
        {
            if (input == null)
                return false;
