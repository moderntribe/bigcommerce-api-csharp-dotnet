...
namespace OrdersV3.Model
{
        ...
        public partial class PaymentRequest :  IEquatable<PaymentRequest>, IValidatableObject
    {
        ...
        /// <param name="amount">Amount refunded via this provider.</param>
        /// <param name="offline">Whether the payment was marked as offline or performed through an online payment service..</param>
        public PaymentRequest(string providerId = default(string), decimal? amount = default(decimal?), bool? offline = default(bool?))
        {
