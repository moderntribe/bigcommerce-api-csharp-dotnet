...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AVSResult :  IEquatable<AVSResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AVSResult" /> class.
        /// </summary>
        ...
        public AVSResult(string code = default(string), string message = default(string), string streetMatch = default(string), string postalMatch = default(string))
        {
            this.Code = code;
        ...
        {
            return this.Equals(input as AVSResult);
        }

        /// <summary>
        /// Returns true if AVSResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AVSResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AVSResult input)
        {
            if (input == null)
                return false;
