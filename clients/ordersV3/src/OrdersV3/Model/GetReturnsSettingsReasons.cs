...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GetReturnsSettingsReasons :  IEquatable<GetReturnsSettingsReasons>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReturnsSettingsReasons" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="label">A description of the reason.</param>
        /// <param name="isArchived">Indicates whether or not the reason has been archived.</param>
        public GetReturnsSettingsReasons(long? id = default(long?), string label = default(string), bool? isArchived = default(bool?))
        {
            this.Id = id;
            this.Label = label;
        ...
        /// </summary>
        /// <value>A description of the reason</value>
        ...
        /// </summary>
        /// <value>Indicates whether or not the reason has been archived</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetReturnsSettingsReasons {\n");
        ...
        {
            return this.Equals(input as GetReturnsSettingsReasons);
        }

        /// <summary>
        /// Returns true if GetReturnsSettingsReasons instances are equal
        /// </summary>
        /// <param name="input">Instance of GetReturnsSettingsReasons to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetReturnsSettingsReasons input)
        {
            if (input == null)
                return false;
