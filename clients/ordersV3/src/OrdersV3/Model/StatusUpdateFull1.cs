...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StatusUpdateFull1 :  IEquatable<StatusUpdateFull1>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StatusUpdateFull1" /> class.
        /// </summary>
        ...
        public StatusUpdateFull1(long? returnId = default(long?), NewStatusEnum? newStatus = default(NewStatusEnum?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StatusUpdateFull1 {\n");
        ...
        {
            return this.Equals(input as StatusUpdateFull1);
        }

        /// <summary>
        /// Returns true if StatusUpdateFull1 instances are equal
        /// </summary>
        /// <param name="input">Instance of StatusUpdateFull1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StatusUpdateFull1 input)
        {
            if (input == null)
                return false;
