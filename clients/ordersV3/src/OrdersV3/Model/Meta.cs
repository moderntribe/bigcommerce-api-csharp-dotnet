...
namespace OrdersV3.Model
{
        ...
        public partial class Meta :  IEquatable<Meta>, IValidatableObject
    {
        ...
        public Meta(Pagination1 meta = default(Pagination1))
        {
            this._Meta = meta;
        }
        ...
        public Pagination1 _Meta { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _Meta: ").Append(_Meta).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                int hashCode = 41;
                if (this._Meta != null)
                    hashCode = hashCode * 59 + this._Meta.GetHashCode();
                return hashCode;
            }
        }
