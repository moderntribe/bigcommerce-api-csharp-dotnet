...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ItemReferenceId :  IEquatable<ItemReferenceId>, IValidatableObject
    {
        /// <summary>
        /// The reference type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemReferenceId" /> class.
        /// </summary>
        /// <param name="type">The reference type (required).</param>
        /// <param name="value">The value identifying the returned item (required).</param>
        public ItemReferenceId(TypeEnum type = default(TypeEnum), string value = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ItemReferenceId and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for ItemReferenceId and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ItemReferenceId {\n");
        ...
        {
            return this.Equals(input as ItemReferenceId);
        }

        /// <summary>
        /// Returns true if ItemReferenceId instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemReferenceId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemReferenceId input)
        {
            if (input == null)
                return false;
