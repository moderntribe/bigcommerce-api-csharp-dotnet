...
namespace OrdersV3.Model
{
        ...
        public partial class MetaFieldCollectionResponse :  IEquatable<MetaFieldCollectionResponse>, IValidatableObject
    {
        ...
        public MetaFieldCollectionResponse(List<AllOfMetaFieldCollectionResponseDataItems> data = default(List<AllOfMetaFieldCollectionResponseDataItems>), CollectionMeta meta = default(CollectionMeta))
        {
            this.Data = data;
            this.Meta = meta;
        }
