...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorDetailedFull :  IEquatable<ErrorDetailedFull>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorDetailedFull" /> class.
        /// </summary>
        /// <param name="errors">errors.</param>
        public ErrorDetailedFull(Dictionary<string, string> errors = default(Dictionary<string, string>))
        {
            this.Errors = errors;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ErrorDetailedFull {\n");
        ...
        {
            return this.Equals(input as ErrorDetailedFull);
        }

        /// <summary>
        /// Returns true if ErrorDetailedFull instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorDetailedFull to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorDetailedFull input)
        {
            if (input == null)
                return false;
