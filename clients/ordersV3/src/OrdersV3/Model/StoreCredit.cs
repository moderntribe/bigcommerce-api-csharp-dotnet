...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class StoreCredit :  IEquatable<StoreCredit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StoreCredit" /> class.
        /// </summary>
        /// <param name="remainingBalance">Remaining balance of shopper&#x27;s store credit. .</param>
        public StoreCredit(string remainingBalance = default(string))
        {
        ...
        {
            return this.Equals(input as StoreCredit);
        }

        /// <summary>
        /// Returns true if StoreCredit instances are equal
        /// </summary>
        /// <param name="input">Instance of StoreCredit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StoreCredit input)
        {
            if (input == null)
                return false;
