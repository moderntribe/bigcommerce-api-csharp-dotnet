...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturnRequestReferenceId :  IEquatable<CreateReturnRequestReferenceId>, IValidatableObject
    {
        /// <summary>
        /// The reference type
        /// </summary>
        ...
        {
            /// <summary>
            /// Enum PRODUCT for value: ORDER_PRODUCT
            /// </summary>
            [EnumMember(Value = "ORDER_PRODUCT")]
            PRODUCT = 1        }
        /// <summary>
        /// The reference type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturnRequestReferenceId" /> class.
        /// </summary>
        /// <param name="type">The reference type (required).</param>
        /// <param name="value">The value identifying the returned item (required).</param>
        public CreateReturnRequestReferenceId(TypeEnum type = default(TypeEnum), string value = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for CreateReturnRequestReferenceId and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CreateReturnRequestReferenceId and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        /// </summary>
        /// <value>The value identifying the returned item</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateReturnRequestReferenceId {\n");
        ...
        {
            return this.Equals(input as CreateReturnRequestReferenceId);
        }

        /// <summary>
        /// Returns true if CreateReturnRequestReferenceId instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturnRequestReferenceId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturnRequestReferenceId input)
        {
            if (input == null)
                return false;
