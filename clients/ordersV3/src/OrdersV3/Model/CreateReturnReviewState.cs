...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturnReviewState :  IEquatable<CreateReturnReviewState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturnReviewState" /> class.
        /// </summary>
        /// <param name="approvedQuantity">The quantity of items approved for return by the merchant.</param>
        /// <param name="pendingQuantity">The quantity of items pending receipt by the merchant.</param>
        /// <param name="rejectedQuantity">The quantity of items rejected by the merchant.</param>
        public CreateReturnReviewState(int? approvedQuantity = default(int?), int? pendingQuantity = default(int?), int? rejectedQuantity = default(int?))
        {
        ...
        /// </summary>
        /// <value>The quantity of items approved for return by the merchant</value>
        ...
        /// </summary>
        /// <value>The quantity of items pending receipt by the merchant</value>
        ...
        /// </summary>
        /// <value>The quantity of items rejected by the merchant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateReturnReviewState {\n");
        ...
        {
            return this.Equals(input as CreateReturnReviewState);
        }

        /// <summary>
        /// Returns true if CreateReturnReviewState instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturnReviewState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturnReviewState input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ApprovedQuantity == input.ApprovedQuantity ||
                    (this.ApprovedQuantity != null &&
                    this.ApprovedQuantity.Equals(input.ApprovedQuantity))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ApprovedQuantity != null)
                    hashCode = hashCode * 59 + this.ApprovedQuantity.GetHashCode();
