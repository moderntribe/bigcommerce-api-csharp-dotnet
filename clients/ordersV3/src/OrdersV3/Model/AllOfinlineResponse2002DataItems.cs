...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfinlineResponse2002DataItems :  IEquatable<AllOfinlineResponse2002DataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfinlineResponse2002DataItems" /> class.
        /// </summary>
        ...
        public AllOfinlineResponse2002DataItems(int? id = default(int?), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfinlineResponse2002DataItems {\n");
        ...
        {
            return this.Equals(input as AllOfinlineResponse2002DataItems);
        }

        /// <summary>
        /// Returns true if AllOfinlineResponse2002DataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfinlineResponse2002DataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfinlineResponse2002DataItems input)
        {
            if (input == null)
                return false;
