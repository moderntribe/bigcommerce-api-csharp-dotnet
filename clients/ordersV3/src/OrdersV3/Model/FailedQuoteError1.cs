...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FailedQuoteError1 :  IEquatable<FailedQuoteError1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FailedQuoteError1" /> class.
        /// </summary>
        /// <param name="orderId">orderId.</param>
        /// <param name="status">HTTP status code.</param>
        /// <param name="error">details why the request failed.</param>
        public FailedQuoteError1(int? orderId = default(int?), int? status = default(int?), string error = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FailedQuoteError1 {\n");
        ...
        {
            return this.Equals(input as FailedQuoteError1);
        }

        /// <summary>
        /// Returns true if FailedQuoteError1 instances are equal
        /// </summary>
        /// <param name="input">Instance of FailedQuoteError1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FailedQuoteError1 input)
        {
            if (input == null)
                return false;
