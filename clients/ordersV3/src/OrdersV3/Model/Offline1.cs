...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Offline1 :  IEquatable<Offline1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Offline1" /> class.
        /// </summary>
        /// <param name="displayName">Display name for the offline payment. .</param>
        public Offline1(string displayName = default(string))
        {
        ...
        {
            return this.Equals(input as Offline1);
        }

        /// <summary>
        /// Returns true if Offline1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Offline1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Offline1 input)
        {
            if (input == null)
                return false;
