...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Meta1 :  IEquatable<Meta1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Meta1" /> class.
        /// </summary>
        /// <param name="meta">meta.</param>
        public Meta1(Pagination1 meta = default(Pagination1))
        {
            this.Meta = meta;
        }
        ...
        {
            return this.Equals(input as Meta1);
        }

        /// <summary>
        /// Returns true if Meta1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Meta1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Meta1 input)
        {
            if (input == null)
                return false;
