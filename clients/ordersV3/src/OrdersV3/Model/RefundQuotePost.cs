...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefundQuotePost :  IEquatable<RefundQuotePost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundQuotePost" /> class.
        /// </summary>
        ...
        public RefundQuotePost(int? orderId = default(int?), List<Object> items = default(List<Object>))
        {
            // to ensure "orderId" is required (not null)
            if (orderId == null)
            {
                throw new InvalidDataException("orderId is a required property for RefundQuotePost and cannot be null");
            }
            else
            {
            ...
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for RefundQuotePost and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundQuotePost {\n");
        ...
        {
            return this.Equals(input as RefundQuotePost);
        }

        /// <summary>
        /// Returns true if RefundQuotePost instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundQuotePost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundQuotePost input)
        {
            if (input == null)
                return false;
