...
namespace OrdersV3.Model
{
        ...
        public partial class InlineResponse503 :  IEquatable<InlineResponse503>, IValidatableObject
    {
        ...
        public InlineResponse503(List<FailedQuoteError1> data = default(List<FailedQuoteError1>), Meta1 meta = default(Meta1))
        {
            this.Data = data;
            this.Meta = meta;
        }
        ...
        public List<FailedQuoteError1> Data { get; set; }
        ...
        {
            return this.Equals(input as InlineResponse503);
        }

        /// <summary>
        /// Returns true if InlineResponse503 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse503 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse503 input)
        {
            if (input == null)
                return false;
