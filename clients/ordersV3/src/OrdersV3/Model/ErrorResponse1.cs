...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ErrorResponse1 :  IEquatable<ErrorResponse1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorResponse1" /> class.
        /// </summary>
        /// <param name="errors">errors.</param>
        /// <param name="status">The HTTP status code. .</param>
        /// <param name="title">The error title describing the particular error. .</param>
        /// <param name="type">type.</param>
        public ErrorResponse1(Dictionary<string, string> errors = default(Dictionary<string, string>), int? status = default(int?), string title = default(string), string type = default(string))
        {
            this.Errors = errors;
            this.Status = status;
            this.Title = title;
        ...
        {
            return this.Equals(input as ErrorResponse1);
        }

        /// <summary>
        /// Returns true if ErrorResponse1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorResponse1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorResponse1 input)
        {
            if (input == null)
                return false;
