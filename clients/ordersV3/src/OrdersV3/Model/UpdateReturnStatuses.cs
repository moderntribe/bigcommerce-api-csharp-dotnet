...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateReturnStatuses : List<UpdateReturnStatusesInner>,  IEquatable<UpdateReturnStatuses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateReturnStatuses" /> class.
        /// </summary>
        public UpdateReturnStatuses() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateReturnStatuses {\n");
        ...
        {
            return this.Equals(input as UpdateReturnStatuses);
        }

        /// <summary>
        /// Returns true if UpdateReturnStatuses instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateReturnStatuses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateReturnStatuses input)
        {
            if (input == null)
                return false;
