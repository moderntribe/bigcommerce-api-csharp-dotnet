...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Custom1 :  IEquatable<Custom1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Custom1" /> class.
        /// </summary>
        /// <param name="paymentMethod">Text entered for the payment method in the control panel. .</param>
        public Custom1(string paymentMethod = default(string))
        {
        ...
        {
            return this.Equals(input as Custom1);
        }

        /// <summary>
        /// Returns true if Custom1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Custom1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Custom1 input)
        {
            if (input == null)
                return false;
