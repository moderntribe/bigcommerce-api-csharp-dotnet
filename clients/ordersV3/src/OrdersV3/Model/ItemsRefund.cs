...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ItemsRefund : List<Object>,  IEquatable<ItemsRefund>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemsRefund" /> class.
        /// </summary>
        public ItemsRefund() : base()
        {
        }
        ...
        {
            return this.Equals(input as ItemsRefund);
        }

        /// <summary>
        /// Returns true if ItemsRefund instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemsRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemsRefund input)
        {
            if (input == null)
                return false;
