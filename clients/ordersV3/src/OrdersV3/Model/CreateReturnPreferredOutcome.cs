...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturnPreferredOutcome :  IEquatable<CreateReturnPreferredOutcome>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturnPreferredOutcome" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the preferred outcome.</param>
        /// <param name="label">A displayable label for the preferred outcome.</param>
        public CreateReturnPreferredOutcome(long? id = default(long?), string label = default(string))
        {
            this.Id = id;
            this.Label = label;
        }
        ...
        /// </summary>
        /// <value>Unique identifier of the preferred outcome</value>
        ...
        /// </summary>
        /// <value>A displayable label for the preferred outcome</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateReturnPreferredOutcome {\n");
        ...
        {
            return this.Equals(input as CreateReturnPreferredOutcome);
        }

        /// <summary>
        /// Returns true if CreateReturnPreferredOutcome instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturnPreferredOutcome to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturnPreferredOutcome input)
        {
            if (input == null)
                return false;
