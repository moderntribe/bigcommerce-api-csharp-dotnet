...
namespace OrdersV3.Model
{
        ...
        public partial class Problem :  IEquatable<Problem>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="status">Status code of the problem.</param>
        /// <param name="title">A short description of the problem.</param>
        /// <param name="type">A resource describing the problem.</param>
        public Problem(int? status = default(int?), string title = default(string), string type = default(string))
        {
            this.Status = status;
            this.Title = title;
            this.Type = type;
        ...
        /// </summary>
        /// <value>Status code of the problem</value>
        ...
        /// </summary>
        /// <value>A short description of the problem</value>
        ...
        /// </summary>
        /// <value>A resource describing the problem</value>
