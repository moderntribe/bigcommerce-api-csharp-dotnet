...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RefundQuoteFull1 :  IEquatable<RefundQuoteFull1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RefundQuoteFull1" /> class.
        /// </summary>
        ...
        public RefundQuoteFull1(int? orderId = default(int?), float? totalRefundAmount = default(float?), decimal? totalRefundTaxAmount = default(decimal?), decimal? rounding = default(decimal?), float? adjustment = default(float?), bool? taxInclusive = default(bool?), List<List<Object>> refundMethods = default(List<List<Object>>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RefundQuoteFull1 {\n");
        ...
        {
            return this.Equals(input as RefundQuoteFull1);
        }

        /// <summary>
        /// Returns true if RefundQuoteFull1 instances are equal
        /// </summary>
        /// <param name="input">Instance of RefundQuoteFull1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RefundQuoteFull1 input)
        {
            if (input == null)
                return false;
