...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfinlineResponse200DataItems :  IEquatable<AllOfinlineResponse200DataItems>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfinlineResponse200DataItems" /> class.
        /// </summary>
        ...
        /// <param name="avsResult">Address Verification Service (AVS) result from the payment gateway..</param>
        /// <param name="cvvResult">Card Verification Value result from the payment gateway..</param>
        /// <param name="creditCard">A credit-card model..</param>
        /// <param name="giftCertificate">A gift-certificate model..</param>
        /// <param name="storeCredit">A store credit model. .</param>
        public AllOfinlineResponse200DataItems(int? id = default(int?), string orderId = default(string), DateTime? dateCreated = default(DateTime?), string paymentInstrumentToken = default(string), Object avsResult = default(Object), Object cvvResult = default(Object), Object creditCard = default(Object), Object giftCertificate = default(Object), Object storeCredit = default(Object))
        {
            this.Id = id;
        ...
        /// </summary>
        /// <value>Address Verification Service (AVS) result from the payment gateway.</value>
        ...
        /// </summary>
        /// <value>Card Verification Value result from the payment gateway.</value>
        [DataMember(Name="cvv_result", EmitDefaultValue=false)]
        public Object CvvResult { get; set; }

        /// <summary>
        /// A credit-card model.
        /// </summary>
        /// <value>A credit-card model.</value>
        ...
        /// </summary>
        /// <value>A gift-certificate model.</value>
        ...
        /// </summary>
        /// <value>A store credit model. </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfinlineResponse200DataItems {\n");
        ...
        {
            return this.Equals(input as AllOfinlineResponse200DataItems);
        }

        /// <summary>
        /// Returns true if AllOfinlineResponse200DataItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfinlineResponse200DataItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfinlineResponse200DataItems input)
        {
            if (input == null)
                return false;
