...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class GetReturnsSettingsPreferredOutcomes :  IEquatable<GetReturnsSettingsPreferredOutcomes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReturnsSettingsPreferredOutcomes" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="label">A description of the outcome.</param>
        /// <param name="isArchived">Indicates whether or not the outcome has been archived.</param>
        public GetReturnsSettingsPreferredOutcomes(long? id = default(long?), string label = default(string), bool? isArchived = default(bool?))
        {
            this.Id = id;
            this.Label = label;
        ...
        /// </summary>
        /// <value>Indicates whether or not the outcome has been archived</value>
        [DataMember(Name="is_archived", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetReturnsSettingsPreferredOutcomes {\n");
        ...
        {
            return this.Equals(input as GetReturnsSettingsPreferredOutcomes);
        }

        /// <summary>
        /// Returns true if GetReturnsSettingsPreferredOutcomes instances are equal
        /// </summary>
        /// <param name="input">Instance of GetReturnsSettingsPreferredOutcomes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetReturnsSettingsPreferredOutcomes input)
        {
            if (input == null)
                return false;
