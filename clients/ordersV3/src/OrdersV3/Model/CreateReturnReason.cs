...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturnReason :  IEquatable<CreateReturnReason>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturnReason" /> class.
        /// </summary>
        /// <param name="id">Unique identifier of the reason.</param>
        /// <param name="label">A displayable label for the reason.</param>
        public CreateReturnReason(long? id = default(long?), string label = default(string))
        {
            this.Id = id;
            this.Label = label;
        }
        ...
        /// </summary>
        /// <value>Unique identifier of the reason</value>
        ...
        /// </summary>
        /// <value>A displayable label for the reason</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateReturnReason {\n");
        ...
        {
            return this.Equals(input as CreateReturnReason);
        }

        /// <summary>
        /// Returns true if CreateReturnReason instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturnReason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturnReason input)
        {
            if (input == null)
                return false;
