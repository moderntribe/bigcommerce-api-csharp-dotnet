...
namespace OrdersV3.Model
{
        ...
        public partial class PaginationFull :  IEquatable<PaginationFull>, IValidatableObject
    {
        ...
        public PaginationFull(int? total = default(int?), int? count = default(int?), int? perPage = default(int?), int? currentPage = default(int?), int? totalPages = default(int?), LinksFull1 links = default(LinksFull1))
        {
            this.Total = total;
            this.Count = count;
