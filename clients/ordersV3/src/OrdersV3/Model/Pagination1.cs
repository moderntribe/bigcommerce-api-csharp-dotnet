...
namespace OrdersV3.Model
{
        ...
        public partial class Pagination1 :  IEquatable<Pagination1>, IValidatableObject
    {
        ...
        public Pagination1(int? total = default(int?), int? count = default(int?), int? perPage = default(int?), int? currentPage = default(int?), int? totalPages = default(int?), PaginationLinks links = default(PaginationLinks))
        {
            this.Total = total;
            this.Count = count;
