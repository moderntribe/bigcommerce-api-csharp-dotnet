...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MetaRefund :  IEquatable<MetaRefund>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MetaRefund" /> class.
        /// </summary>
        /// <param name="failure">failure.</param>
        /// <param name="success">success.</param>
        /// <param name="total">total.</param>
        public MetaRefund(int? failure = default(int?), int? success = default(int?), int? total = default(int?))
        {
        ...
        {
            return this.Equals(input as MetaRefund);
        }

        /// <summary>
        /// Returns true if MetaRefund instances are equal
        /// </summary>
        /// <param name="input">Instance of MetaRefund to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MetaRefund input)
        {
            if (input == null)
                return false;
