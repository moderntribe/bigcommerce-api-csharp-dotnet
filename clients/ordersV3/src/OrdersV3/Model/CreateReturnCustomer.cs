...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturnCustomer :  IEquatable<CreateReturnCustomer>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturnCustomer" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="email">email.</param>
        public CreateReturnCustomer(long? id = default(long?), string email = default(string))
        {
            this.Id = id;
            this.Email = email;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateReturnCustomer {\n");
        ...
        {
            return this.Equals(input as CreateReturnCustomer);
        }

        /// <summary>
        /// Returns true if CreateReturnCustomer instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturnCustomer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturnCustomer input)
        {
            if (input == null)
                return false;
