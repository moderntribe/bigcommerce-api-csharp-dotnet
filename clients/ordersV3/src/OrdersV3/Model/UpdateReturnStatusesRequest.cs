...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateReturnStatusesRequest : List<StatusUpdateFull1>,  IEquatable<UpdateReturnStatusesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateReturnStatusesRequest" /> class.
        /// </summary>
        public UpdateReturnStatusesRequest() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateReturnStatusesRequest {\n");
        ...
        {
            return this.Equals(input as UpdateReturnStatusesRequest);
        }

        /// <summary>
        /// Returns true if UpdateReturnStatusesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateReturnStatusesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateReturnStatusesRequest input)
        {
            if (input == null)
                return false;
