...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturn :  IEquatable<CreateReturn>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturn" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateReturn);
        }

        /// <summary>
        /// Returns true if CreateReturn instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturn input)
        {
            if (input == null)
                return false;
