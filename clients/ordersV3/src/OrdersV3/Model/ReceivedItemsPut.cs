...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReceivedItemsPut : List<ReceivedItemsPutInner>,  IEquatable<ReceivedItemsPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivedItemsPut" /> class.
        /// </summary>
        public ReceivedItemsPut() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReceivedItemsPut {\n");
        ...
        {
            return this.Equals(input as ReceivedItemsPut);
        }

        /// <summary>
        /// Returns true if ReceivedItemsPut instances are equal
        /// </summary>
        /// <param name="input">Instance of ReceivedItemsPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReceivedItemsPut input)
        {
            if (input == null)
                return false;
