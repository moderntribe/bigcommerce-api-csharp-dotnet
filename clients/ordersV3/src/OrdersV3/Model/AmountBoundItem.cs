...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AmountBoundItem :  IEquatable<AmountBoundItem>, IValidatableObject
    {
        /// <summary>
        /// Type of refund.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AmountBoundItem" /> class.
        /// </summary>
        /// <param name="itemType">Type of refund..</param>
        /// <param name="itemId">Order address ID..</param>
        ...
        public AmountBoundItem(ItemTypeEnum? itemType = default(ItemTypeEnum?), int? itemId = default(int?), float? amount = default(float?), string reason = default(string))
        {
        ...
        {
            return this.Equals(input as AmountBoundItem);
        }

        /// <summary>
        /// Returns true if AmountBoundItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AmountBoundItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AmountBoundItem input)
        {
            if (input == null)
                return false;
