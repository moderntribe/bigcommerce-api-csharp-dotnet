...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReceivedItemsBase : List<ReceivedItemsBaseInner>,  IEquatable<ReceivedItemsBase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReceivedItemsBase" /> class.
        /// </summary>
        public ReceivedItemsBase() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReceivedItemsBase {\n");
        ...
        {
            return this.Equals(input as ReceivedItemsBase);
        }

        /// <summary>
        /// Returns true if ReceivedItemsBase instances are equal
        /// </summary>
        /// <param name="input">Instance of ReceivedItemsBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReceivedItemsBase input)
        {
            if (input == null)
                return false;
