...
namespace OrdersV3.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateReturnReceivedState :  IEquatable<CreateReturnReceivedState>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateReturnReceivedState" /> class.
        /// </summary>
        /// <param name="receivedQuantity">The quantity of items marked as received by the merchant.</param>
        /// <param name="pendingQuantity">The quantity of items pending receipt by the merchant.</param>
        public CreateReturnReceivedState(int? receivedQuantity = default(int?), int? pendingQuantity = default(int?))
        {
        ...
        /// </summary>
        /// <value>The quantity of items marked as received by the merchant</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateReturnReceivedState {\n");
        ...
        {
            return this.Equals(input as CreateReturnReceivedState);
        }

        /// <summary>
        /// Returns true if CreateReturnReceivedState instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateReturnReceivedState to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateReturnReceivedState input)
        {
            if (input == null)
                return false;
