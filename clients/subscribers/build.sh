...
${nuget_cmd} install src/Subscribers/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Subscribers.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Subscribers.dll \
-recurse:'src/Subscribers/*.cs' \
-doc:bin/Subscribers.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Subscribers.dll was created successfully"
fi
