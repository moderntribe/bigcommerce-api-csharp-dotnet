...
namespace Subscribers.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SubscriberPut :  IEquatable<SubscriberPut>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriberPut" /> class.
        /// </summary>
        public SubscriberPut()
        {
        }
        ...
        {
            return this.Equals(input as SubscriberPut);
        }

        /// <summary>
        /// Returns true if SubscriberPut instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriberPut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriberPut input)
        {
            if (input == null)
                return false;
