...
namespace Subscribers.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SubscriberPut1 :  IEquatable<SubscriberPut1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriberPut1" /> class.
        /// </summary>
        public SubscriberPut1()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscriberPut1 {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SubscriberPut1);
        }

        /// <summary>
        /// Returns true if SubscriberPut1 instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriberPut1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriberPut1 input)
        {
            if (input == null)
                return false;
