...
namespace Subscribers.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SubscriberPost :  IEquatable<SubscriberPost>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriberPost" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubscriberPost {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as SubscriberPost);
        }

        /// <summary>
        /// Returns true if SubscriberPost instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscriberPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriberPost input)
        {
            if (input == null)
                return false;
