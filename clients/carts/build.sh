...
${nuget_cmd} install src/Carts/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Carts.dll"
...
then
  ...
  echo "[INFO] bin/Carts.dll was created successfully"
fi
